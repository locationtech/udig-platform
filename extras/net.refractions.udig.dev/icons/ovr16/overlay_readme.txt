...
Layer Overlay:
  ...
  |  A B   (ends up 27 x 16 pixels, 3 pixel overlap on A)
  |   C
  +--+
...
Session Overlay:
  ...
  +--+ Extend the base 16x16 icon offering positions A and B
  |  B (ends up 20 x 16, 3 pixel overlap on A and B)
  |  A
  +--+
