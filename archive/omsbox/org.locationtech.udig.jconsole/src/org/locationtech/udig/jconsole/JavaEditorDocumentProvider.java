...
public class JavaEditorDocumentProvider extends AbstractDocumentProvider {
    ...
    /**
     * @see
     * org.eclipse.ui.texteditor.AbstractDocumentProvider#createAnnotationModel(java.lang.Object)
     */
    @Override
    ...
    /**
     * @see
     * org.eclipse.ui.texteditor.AbstractDocumentProvider#doSaveDocument(org.eclipse.core.runtime.
                ...
                if (file.exists()) {
                    if (file.canWrite()) {
                        ...
                        throw new CoreException(
                                new Status(IStatus.ERROR, "org.eclipse.ui.examples.rcp.texteditor", //$NON-NLS-1$
                                        IStatus.OK, "file is read-only", null)); //$NON-NLS-1$
                    }
                } else {
                    throw new CoreException(
                            new Status(IStatus.ERROR, "org.eclipse.ui.examples.rcp.texteditor", //$NON-NLS-1$
                                    IStatus.OK, "ERROR creating file", null)); //$NON-NLS-1$
                }
            } catch (IOException e) {
                throw new CoreException(
                        new Status(IStatus.ERROR, "org.eclipse.ui.examples.rcp.texteditor", //$NON-NLS-1$
                                IStatus.OK, "ERROR when saving file", e)); //$NON-NLS-1$
            }
    ...
    /**
     * @see org.eclipse.ui.texteditor.AbstractDocumentProvider#getOperationRunner(org.eclipse.core.
