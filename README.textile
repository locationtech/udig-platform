...
1. * **Java --> Code Style --> Coding Template**
   ...
   Use the :guilabel:`Import` button and select the file :file:`extras/org.locationtech.udig.dev/codetemplates.xml`
...
2. **Java --> Code Style --> Code Formatter**
   ...
   Use the :guilabel:`Import` button and select the file :file:`extras/org.locationtech.udig.dev/codeformatter.xml`
...
5. Open up *org.locationtech.udig/udig.product and click *Run*
...
1. Select :menuselection:`Help --> Eclipse marketplace` from the menu bar
2. Search for "FindBugs" and Insatll
