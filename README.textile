...
3. Save a copy of the target-platform locally
   ...
   Since the target definition uses online resources it's a good idea to export it for offline development porposes.
   To do so, click on the export action top right in the target platform editor.
  
   !extras/images/target-platform-export-01.png!
   ...
   !extras/images/target-platform-export-02.png!
