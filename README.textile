...
uDig is an open project, with developers from multiple companies participating in the decision making process and project direction. All decisions are made transparently, on the public mailing list, or in open <a href="http://en.wikipedia.org/wiki/IRC">IRC</a> discussions.

* "irc://us.freenode.net/udig":#udig on "freenode":http://freenode.net/irc_servers.shtml
* "#geotools":irc://us.freenode.net/geotools on "freenode":http://freenode.net/irc_servers.shtml
