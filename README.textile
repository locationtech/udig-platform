!https://travis-ci.org/uDig/udig-platform.svg?branch=luna-support!:https://travis-ci.org/uDig/udig-platform
...
1. We have two branches in our short term roadmap:
   ...
   * https://github.com/uDig/udig-platform/tree/luna-support
