...
`ShpPropertiesInterceptor.java <http://svn.refractions.net/udig/udig/trunk/tutorials/net.refractions.udig.tutorials.examples/src/net/refractions/udig/tutorials/examples/ShpPropertiesInterceptor.java>`_
