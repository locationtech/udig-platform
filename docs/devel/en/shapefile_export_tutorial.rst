...
-  Available in your uDig SDK (import the `source code <code_examples>` from the plugins
   view)
-  plugin: `net.refractions.udig.tutorials.shpexport <https://github.com/uDig/udig-platform/tree/master/tutorials/net.refractions.udig.tutorials.shpexport>`_ (github)
