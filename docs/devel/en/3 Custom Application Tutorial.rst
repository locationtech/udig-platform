...
* :doc:`http://udig.refractions.net/files/tutorials/CustomApplication.pdf`


Downloads:

* :doc:`http://udig.refractions.net/tutorials/rcp\_branding.zip`
...
-  Available in your uDig SDK (import the `source code <1%20Code%20Examples.html>`_ from the plugins
   view)
-  plugin:
   :doc:`net.refractions.udig.tutorials.customapp`

   (github)
-  feature:
   :doc:`net.refractions.udig\_tutorials.custom-feature`
...
.. figure:: /images/3_custom_application_tutorial/HelloWorld.png
   :align: center
   :alt: 
...
.. figure:: /images/3_custom_application_tutorial/CustomApplicationMenu.png
   :align: center
   :alt: 
...
* :doc:`http://udig.refractions.net/tutorials/rcp\_walkthrough.pdf`


.. |image0| image:: /images/3_custom_application_tutorial/CustomAppWorkbook.png
.. |image1| image:: /images/3_custom_application_tutorial/CustomApplicationSearch.png
