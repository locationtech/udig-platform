...
In adition uDig contributes several workflows for content we manage. Where possible we have
maintained compatibility with the Eclipse User Interface Guidelines.

Workbench Workflow
^^^^^^^^^^^^^^^^^^

The main workbench window follows an open / exit workflow.
