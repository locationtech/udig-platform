1 IAdaptable and Operations
===========================

An introduction to two key concepts: do stuff (udig IOp) in more places (eclipse IAdaptable)!.

.. figure:: /images/1_iadaptable_and_operations/IAdaptableOperationWorkbook.png
   :align: center
   :alt: 
...
-  Available in your uDig SDK (import the `source code <1%20Code%20Examples.html>`_ from the plugins
   view)
-  plugin:
   :doc:`net.refractions.udig.tutorials.urladapter`
...
tutorial <4%20Workbench%20Tutorial.html>`_.
...
.. figure:: /images/1_iadaptable_and_operations/DisplayURL.png
   :align: center
   :alt: 
