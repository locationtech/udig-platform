1 CSVService Tutorial
=====================

Step one of our disk to screen tour is access to data.

.. figure:: /images/1_csvservice_tutorial/CSVServiceTutorial.png
   :align: center
   :alt: 
...
-  plugin:
   ...
   * :doc:`com.csvreader`
      ...
      (github)
   * :doc:`net.refractions.udig.tutorials.catalog.csv`
...
.. figure:: /images/1_csvservice_tutorial/CSVService.png
   :align: center
   :alt: 
