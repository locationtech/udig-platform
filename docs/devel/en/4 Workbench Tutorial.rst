...
The view you create in this tutorial is a great tool to understand what uDig is up to; and how you
can take part.
...
* :doc:`http://udig.refractions.net/files/tutorials/WorkbenchSelection.pdf`


Resources:

* :doc:`http://udig.refractions.net/files/tutorials/workbench\_icons.zip`
...
-  Available in your uDig SDK (import the `source code <1%20Code%20Examples.html>`_ from the plugins
   view)
-  plugin:
   :doc:`net.refractions.udig.tutorials.workbench`
...
.. figure:: /images/4_workbench_tutorial/WorkbenchSelection.jpg
   :align: center
   :alt: 
...
* :doc:`http://udig.refractions.net/files/tutorials/workbench.pdf`


.. |image0| image:: /images/4_workbench_tutorial/WorkbenchSelectionWorkbook.png
