...
.. figure:: /images/1_coordinate_mapgraphic/CoordinateMapGraphicWorkbook.png
   :align: center
   :alt: 
...
Coordiante MapGraphic Tutorial
==============================
...
-  plugin:
   ...
   * :doc:`net.refractions.udig.tutorials.tool.coordinate`

      (github)
   * :doc:`net.refractions.udig.tutorials.mapgraphic`
...
* :doc:`http://docs.geotools.org/latest/userguide/library/referencing/crs.html`

* :doc:`http://docs.geotools.org/latest/userguide/library/api/jts.html`
