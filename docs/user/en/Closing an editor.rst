...
If the editor was closed using :menuselection:`File --> Close`, notice that the option :menuselection:`File --> Close All` was
also displayed. This is a quick way to close all of the open editors. If :menuselection:`File --> Close All` is
chosen, a prompt will appear to choose which editors with unsaved changes should be saved.
