...
The main uDig application is a cross platform application (available on windows, linux and mac osx).
You can install additional functionality (from update sites) after your initial set up and
configuration.
