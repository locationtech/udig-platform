...
public class MoveVertexBehaviorTest {
    ...
    public void testUndo() throws Exception {
        ...
        handler.getContext().getMap()
                .sendCommandSync(tracker.getCommand(handler, event, EventType.RELEASED));
    ...
    public void testPostSnapping() throws Exception {
        ...
        FeatureSource<SimpleFeatureType, SimpleFeature> source = editLayer
        ...
        event = new MapMouseEvent(DISPLAY, pointOnScreen.x + 5, pointOnScreen.y, NONE, BUTTON1,
                BUTTON1);
        mode.getCommand(handler, event, EventType.DRAGGED);
        handler.handleEvent(event, EventType.RELEASED);
