...
public class Messages extends NLS {
    ...
    public static String ExportResourceSelectionPage_browse;
    public static String ExportResourceSelectionPage_destination;
    public static String ExportResourceSelectionPage_resourceLabel;
    public static String ExportResourceSelectionPage_tooltip;
    public static String ExportResourceSelectionPage_undefinedCRS;
	...
	public static String DataBaseRegistryWizardPage_label_username_tooltip ;
	public static String DataBaseRegistryWizardPage_label_username_text    ;
	public static String DataBaseRegistryWizardPage_label_schema_tooltip   ;
	public static String DataBaseRegistryWizardPage_label_schema_text      ;
	public static String DataBaseRegistryWizardPage_label_port_tooltip     ;
	public static String DataBaseRegistryWizardPage_label_port_text        ;
	public static String DataBaseRegistryWizardPage_label_password_tooltip ;
	public static String DataBaseRegistryWizardPage_label_password_text    ;
	public static String DataBaseRegistryWizardPage_label_host_tooltip     ;
	public static String DataBaseRegistryWizardPage_label_host_text        ;
	public static String DataBaseRegistryWizardPage_label_database_tooltip ;
