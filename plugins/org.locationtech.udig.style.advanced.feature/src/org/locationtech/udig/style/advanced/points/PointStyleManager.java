 ...
 */
public class PointStyleManager extends StyleManager {
            ...
            public Image getImage( Object element ) {
                if (element instanceof StyleWrapper) {
                    ...
                    for( FeatureTypeStyleWrapper featureTypeStyle : featureTypeStyles ) {
                        ...
                        BufferedImage tmpImage = WrapperUtilities.pointRulesWrapperToImage(rulesWrapperList, iconSize, iconSize);
    ...
    public void importToStyle( File... files ) throws Exception {
        List<StyleWrapper> styles = getStyles();

        for( File file : files ) {
            String name = file.getName();
            File newFile = new File(styleFolderFile, name);
            FileUtils.copyFile(file, newFile);
            StyleWrapper style = WrapperUtilities.createStyleFromGraphic(newFile);
            styles.add(style);
            styleToDisk(style);
        }
