...
/**
 * Add a vertex to the current {@link EditGeom} with the characteristic that never will had a vertex
 * if ones exist at the same coordinate. Collaboration: {@link AddVertexCommand}.
 * 
 * 
...
public class AddCustomVertexCommand extends AddVertexCommand implements UndoableMapCommand {
    ...
    public AddCustomVertexCommand(EditToolHandler handler2, EditBlackboard bb,
            IBlockingProvider<PrimitiveShape> provider, Coordinate coordinate, PrimitiveShape shape) {
