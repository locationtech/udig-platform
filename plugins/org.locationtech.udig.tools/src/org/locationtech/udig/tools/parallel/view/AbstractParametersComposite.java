...
public abstract class AbstractParametersComposite extends Composite implements Observer {
    ...
    /**
     * The thread that creates the SWT controls, is needed because only the creator thread could
     * edit SWT controls.
     */
    ...
    private void createCompositeLegend(Composite parent) {
        ...
        InfoMessage infoMessage = new InfoMessage(Messages.PrecisionParallel_InitialMessage,
                Type.INFORMATION);
    ...
    /**
     * Set the {@link PrecisionToolsContext}, add this composite as observer and show its widget.
     * 
     * @param toolContext
     */
    ...
    /**
     * Commit. Not a real commit, it makes the same as a double-click, add the feature to the layer.
     */
