...
public final class AlgorithmUtils {
     ...
     * 
     * @param firstSegment First segment to be checked.
     * @param interSegment Second segment to be checked.
     * @param firstSegC Both coordinates of the first segment.
    ...
    public static Coordinate getIntersectionCoord(final Geometry firstSegment,
            final Geometry interSegment, final Coordinate[] firstSegC) {
        ...
        if (firstSegment.intersects(interSegment)) {
            ...
            for (int k = 0; k < resultPoints.getNumGeometries(); k++) {
                ...
                // the segment.
                if (!(firstSegC[1].equals2D(intersectionCoord))
                        && !(firstSegC[0].equals2D(intersectionCoord))) {
