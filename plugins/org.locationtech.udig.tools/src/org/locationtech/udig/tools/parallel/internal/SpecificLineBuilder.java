...
final class SpecificLineBuilder {
    ...
    /**
     * Mount the line. This function will have to join 2 lineString following the next rule:
     * 
     * It will analyze the 4 coordinates, and will mount a line with the 2 coordinates that are most
     * far-off.
     * 
     * @param key
     * @param value
    ...
    public LineString mountTheLine(LineSegment key, LineSegment value, GeometryFactory gf) {
        ...
        if (resultRef1.equals(resultRef2)) {
            ...
            finalCoords = mountLineReferencesEqual(resultRef1, resultOff1, resultOff2, finalCoords,
                    coordsFromRef, coordsFromOff);
        }
        if (resultOff1.equals(resultOff2)) {

            finalCoords = mountLineOffsetEqual(resultOff1, resultRef1, resultRef2, finalCoords,
                    coordsFromRef, coordsFromOff);
        }
        finalCoords = mountLineRestOfTheCases(resultRef1, resultRef2, resultOff1, resultOff2,
                finalCoords, coordsFromRef, coordsFromOff);
    ...
    /**
     * Analyze the reference 1 segment. Will return which coordinate is the farthest to this point.
     * 
     * @param coordsFromRef
     * @param coordsFromOff
     * @return
    ...
    /**
     * Analyze the reference 2 segment. Will return which coordinate is the farthest to this point.
     * 
     * @param coordsFromRef
     * @param coordsFromOff
     * @return
    ...
    /**
     * Analyze the offset 1 segment. Will return which coordinate is the farthest to this point.
     * 
     * @param coordsFromOff
     * @param coordsFromRef
     * @return
    ...
    /**
     * Analyze the offset 2 segment. Will return which coordinate is the farthest to this point.
     * 
     * @param coordsFromOff
     * @param coordsFromRef
     * @return
    ...
    /**
     * Mount the line for this case, when the farthest coordinate is the same for both reference 1
     * and 2 segment.
     * 
     * @param resultRef1
     * @param resultOff1
     ...
     * @return
     */
    private Coordinate[] mountLineReferencesEqual(CoordName resultRef1, CoordName resultOff1,
            CoordName resultOff2, Coordinate[] finalCoords, Coordinate[] coordsFromRef,
    ...
    /**
     * Mount the line for this case, when the farthest coordinate is the same for both offset 1 and
     * 2 offset.
     * 
     * @param resultOff1
     * @param resultRef1
     ...
     * @return
     */
    private Coordinate[] mountLineOffsetEqual(CoordName resultOff1, CoordName resultRef1,
            CoordName resultRef2, Coordinate[] finalCoords, Coordinate[] coordsFromRef,
            Coordinate[] coordsFromOff) {
    ...
    /**
     * The rest of the cases. Analyze each of them and return the proper coordinates.
     * 
     * @param resultRef1
     * @param resultRef2
     * @param resultOff1
     ...
     * @return
     */
    private Coordinate[] mountLineRestOfTheCases(CoordName resultRef1, CoordName resultRef2,
            CoordName resultOff1, CoordName resultOff2, Coordinate[] finalCoords,
            Coordinate[] coordsFromRef, Coordinate[] coordsFromOff) {
