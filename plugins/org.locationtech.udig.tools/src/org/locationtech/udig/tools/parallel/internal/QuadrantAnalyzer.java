...
final class QuadrantAnalyzer {
     ...
     * 
     * @param inputList List with the created coordinates.
     * @param sourceList List with the original coordinates.
     * @param index Index of the first segment.
     * @param intersectionLastPosition Index of second segment.
     */
    public QuadrantAnalyzer(final List<Coordinate> inputList, final List<Coordinate> sourceList,
            int index, int intersectionLastPosition) {
     ...
     * @param realIntersectionCoord The intersection of the segment off the input list.
     * @param imaginaryCoord The non existent intersection of the segment off the source list.
     */
    public QuadrantAnalyzer(final List<Coordinate> inputList, final List<Coordinate> sourceList,
            int index, int intersectionLastPosition, int size, Coordinate realIntersectionCoord,
    ...
    /**
     * Get the coordinates of the analyzed segment. Those coordinate will depend on the provided
     * 'index' and 'intersectionLastPosition'. Will get the coordinates from the input list and from
     * the source list and analyze them.
     */
    ...
    /**
     * Meanwhile the analyze process, for each coordinate is stored if it was valid or not. This
     * function will return true if all of those analyzed coordinates were true.
     * 
     ...
     * Get the coordinates of the analyzed segment. Those coordinate will depend on the provided
     * 'index' and 'intersectionLastPosition'. Will get the coordinates from the input list and from
     * the source list and analyze them using the provided intersections as referent points.
     * 
     */
    ...
    /**
     * Will analyze each coordinate respect the provided intersection coordinate. And compare with
     * the result of the analyzed source coordinate with the imaginary segment.
     * 
     * The parameters are the coordinates, 2 segment, 4 coordinates and its respective coordinate
     * off the source list. Totally 8 coordinate will be part of that.
     * 
     * @param s1p1
     * @param s1p2
     * @param s2p1
     ...
     * @param s2p2src
     */
    private void analyzeUsingIntersection(final Coordinate s1p1, final Coordinate s1p2,
            final Coordinate s2p1, final Coordinate s2p2, final Coordinate s1p1src,
            final Coordinate s1p2src, final Coordinate s2p1src, final Coordinate s2p2src) {
     ...
     * @param s2p2src
     */
    private void analyze(final Coordinate s1p1, final Coordinate s1p2, final Coordinate s2p1,
            final Coordinate s2p2, final Coordinate s1p1src, final Coordinate s1p2src,
            final Coordinate s2p1src, final Coordinate s2p2src) {
