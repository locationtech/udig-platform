...
public final class DialogUtil {
     ...
     *        in the background.
     * @param process the task to execute.
     * @param runASync
     * @param confirmCancelRequests wether to ask the user to confirm the cancelation when the
     *        cancel button is pressed
     */
    public static void runInProgressDialog(final String dialogTitle,
            final boolean showRunInBackground, final IRunnableWithProgress process,
            boolean runASync, final boolean confirmCancelRequests) {
        Runnable object = new Runnable() {
            ...
            public void run() {
                ...
                ProgressMonitorDialog dialog = DialogUtil.openProgressMonitorDialog(shell,
                        dialogTitle, showRunInBackground, confirmCancelRequests);
                ...
                try {
                    ...
                    dialog.run(true, true, new IRunnableWithProgress() {
                        ...
                        public void run(IProgressMonitor monitor) throws InvocationTargetException,
                            ...
                            try {
                                PlatformGISMediator.runBlockingOperation(
    ...
    public static ProgressMonitorDialog openProgressMonitorDialog(final Shell shell,
            final String dialogTitle, final boolean showRunInBackground,
            final boolean confirmCancelRequests) {
        ...
        ProgressMonitorDialog dialog = new ProgressMonitorDialog(shell) {
            ...
            private void createBackgroundButton(Composite parent) {
                createButton(parent, IDialogConstants.BACK_ID, Messages.DialogUtil_runInBackground,
                        true);
            }
