 ...
 * DefaultCoordinateSequenceTransformer uses JTS {@code DefaultCoordinateSequenceFactory} then we
 * need to preserve the one used in the GeometryFactory being used by uDig. (aka,
 ...
 */
class CoordSeqFactoryPreservingCoordinateSequenceTransformer extends
    ...
    /**
     * Was re-written to use the factory setted by the client module {@inheritDoc}
     */
    @Override
