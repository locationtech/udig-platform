...
public class GeoToolsUtils {
     ...
     */
    public static void copyAttributes(SimpleFeature source, SimpleFeature target)
            throws IllegalAttributeException {
    ...
    public static GeometryCoordinateSequenceTransformer getTransformer(
            final GeometryFactory gFactory, final CoordinateReferenceSystem geomCrs,
     ...
     * @return <code>geom</code> reprojected from <code>geomCrs</code> to <code>reprojectCrs</code>
    ...
    public static Geometry reproject(final Geometry geom, final CoordinateReferenceSystem geomCrs,
        ...
        assert geom != null : "geom cannot be null"; //$NON-NLS-1$
        assert geomCrs != null : "geomCrs cannot be null"; //$NON-NLS-1$
        assert reprojectCrs != null : "reprojectCrs cannot be null"; //$NON-NLS-1$
