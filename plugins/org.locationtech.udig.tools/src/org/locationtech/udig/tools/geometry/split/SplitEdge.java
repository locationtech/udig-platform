...
/**
 * A custom edge class that knows if its an edge from the shell of the polygon being split, one of
 * its holes or the splitting line, by inspecting its label.
 * 
...
final class SplitEdge extends Edge {
     ...
     */
    public static SplitEdge newInstance(final Coordinate firstCoord, final Coordinate secondCoord,
     ...
     * Default constructor.
     * 
     * @param pts Coordinate of the edge.
     * @param label Label for tag the edge, i.e: as interior, exterior, etc.
     */
