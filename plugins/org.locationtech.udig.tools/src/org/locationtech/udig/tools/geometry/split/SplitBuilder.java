...
/**
 * Split builder is responsible of doing the split operation and the add vertex to neighbour in a
 * chain operation.
 * 
 * <p>
 * <b>USAGE:</b>
...
public final class SplitBuilder {
    ...
    /**
     * Gives a list of geometries, it will analyze if those geometries will suffer split or maybe
     * will require the addition of a vertex because the meet the neighbour requirements.
     * 
     * @param allGeometries A list of geometries.
     ...
     * 
     * @param splitGeometries A list of geometries to split.
     * @return The builder instance.
     */
    ...
    /**
     * After doing the {@link #buildSplit(List)} or {@link #buildEntireProcess(List)}, this method
     * returns the resultant geometries from the split operation.
     * 
     * @return
     */
    ...
    /**
     * For each geometry if it meets the requirements for adding a vertex, it will tagged as
     * neighbour and a vertex will be added.
     * 
    ...
    /**
     * After using the method {@link #buildNeighbours(List)}, retrieve the list of geometries with
     * added vertexes.
     * 
