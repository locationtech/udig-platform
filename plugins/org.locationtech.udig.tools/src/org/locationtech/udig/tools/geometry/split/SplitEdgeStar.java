...
/**
 * A {@link DirectedEdgeStar} for the {@link SplitGraphNode nodes} in a {@link SplitGraphBuilder}
 * 
...
class SplitEdgeStar extends DirectedEdgeStar {
    ...
    public void remove(DirectedEdge edge) {
        ...
        if (edge != removed) {
            throw new IllegalArgumentException(
                    "Tried to remove an edge not registered in this edge star: " + edge); //$NON-NLS-1$
        }
     ...
     * 
     * @return The list of Directed edges whose direction is outgoing from this star's node.
     */
     ...
     *         <code>prefferredDirection</code> or <code>null</code> if there are no edges in the
     *         preferred direction.
     */
    public DirectedEdge findClosestEdgeInDirection(final DirectedEdge edge,
     ...
     * @param tail
     * @param tip2
     * @param direction one of {@link CGAlgorithms#CLOCKWISE}, {@link CGAlgorithms#COUNTERCLOCKWISE}
