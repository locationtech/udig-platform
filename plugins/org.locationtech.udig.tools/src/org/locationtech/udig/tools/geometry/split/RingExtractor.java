...
/**
 * 
 * This class is responsible of extracting the rings and the "remaining" line from a line that has
 * at least one self-ring.
 * 
...
public final class RingExtractor {
    ...
    /**
     * Will execute the extraction operation. First it get the rings, and then it "extracts" those
     * rings from the original line getting by this way the remaining line. (it could be a line or a
     * multiline geometry)
     * 
     * @return {@link ResultRingExtractor}. It contains 2 object, one is a list with the rings and
     *         the other is the remaining geometry.
     */
    ...
    /**
     * Get the remaining line by doing the difference operation, and then seek for overlapped lines
     * on the line with its holes. If it founds, add those overlapped lines to the remaining line.
     * 
     * @param originalCoord Coordinates from the original line.
     * @param ringList The extracted rings.
     ...
     * 
     * @param segmentsToAdd Segments to be nodded with the actualResultLine.
     * @param ringList The list of rings.
     * @param actualResultLine The actual lineString.
     * @return The segments nodded to the actualResultLine if they can be nodded.
     */
    private Geometry nodSegments(List<Geometry> segmentsToAdd, List<Geometry> ringList,
            Geometry actualResultLine) {
    ...
    /**
     * Data class that stores the ring extractor data. It'll be the remaining line and the rings.
     */
    public class ResultRingExtractor {
         ...
         * 
         * @param remainingLine The remaining line.
         * @param rings Rings obtained from the extraction process.
         */
