...
public class TestRemotePreferenceStore extends TestCase {
    ...
    public void testDefaults() {
        ...
        assertEquals(val_dbl.doubleValue(), prefStore.getDefaultDouble(key_dbl));
    ...
    public void testWriteAndRead() throws IOException {
        ...
        assertEquals(val2_dbl.doubleValue(), Double.parseDouble(prefStore.getValue(key_dbl)));
