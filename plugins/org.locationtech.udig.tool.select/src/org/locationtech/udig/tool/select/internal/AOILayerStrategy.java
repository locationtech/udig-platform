...
public class AOILayerStrategy extends IAOIStrategy {
     ...
     *
     * @param geometry The geometry to use as the AOI must be type Polygon or Multi-Polygon
     */
    ...
    /**
     * Gets a list of AOI Layers from the active map The list is in z-order
     *
     * @return List<ILayer>
     */
    public List<ILayer> getAOILayers() {
        ...
        List<ILayer> aoiLayers = new ArrayList<>();
    ...
    /**
     * Look up the the previous layer in the map layer list; only AOI layers are considered.
     *
