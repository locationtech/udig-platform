...
public class AbstractRasterGeoResourceInfo extends IGeoResourceInfo {
     ...
     * <p>
     * For formats that have internal structure with multiple internal rasters this title should be
     * determined from the metdata about each raster.
     * </p>
     * 
    ...
    public synchronized ReferencedEnvelope getBounds() {
        if (this.bounds == null) {
            try {
                GridCoverage2DReader source = this.resource.service(new NullProgressMonitor())
                        .getReader(null);
                if (source == null) {
                    return null;
                }
