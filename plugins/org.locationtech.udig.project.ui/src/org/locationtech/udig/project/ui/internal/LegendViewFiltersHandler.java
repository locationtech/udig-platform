...
public class LegendViewFiltersHandler {
    ...
    public Action getToggleMgAction() {
        ...
        if (toggleMgLayerAction == null) {
            ...
            toggleMgLayerAction.setImageDescriptor(ProjectUIPlugin.getDefault()
                    .getImageDescriptor(ISharedImages.TOG_MAP_GRAPHIC_CO));
        }
    ...
    public Action getToggleBgAction() {
        ...
        if (toggleBgLayerAction == null) {
            ...
            toggleBgLayerAction.setImageDescriptor(
                    ProjectUIPlugin.getDefault().getImageDescriptor(ISharedImages.TOG_BG_LAYER_CO));
        }
    ...
    public void setToggleLayersActionState() {
        ...
        if (map == null) {
            ...
            if (!LegendViewUtils.getLayers(map.getLegend(), false).isEmpty()) {
