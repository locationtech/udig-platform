...
/**
 * Abstract class for contribution item that represent the current item selected on the toolbar.
 *
 * @author jeichar
 * @since 0.9.0
 */
public abstract class AbstractToolbarContributionItem extends CurrentContributionItem {
    ...
    /**
     * Selects passed modal tool if the <code>toolItem</code> widget has been created and not
     * disposed. Otherwise just ignore selection until the widget will be created.
     */
    @Override
            ...
            if (currentTool.isEnabled()) {
                ...
                MessageDialog.openWarning(disp.getActiveShell(),
                        ...
                        MessageFormat.format(
                                Messages.AbstractToolbarContributionItem_warning_message,
                                new Object[] { currentTool.getName() }));
            }
        }
    }
