...
public class CopyFeaturesCommandTest {
    ...
    public void setUp() throws Exception {
        ...
        Object[] values = new Object[] {
                builder.safeCreateGeometry(LineString.class,
                        new Coordinate[] { new Coordinate(10, 10), new Coordinate(20, 10),
        ...
        sourceMap = MapTests.createNonDynamicMapAndRenderer(sourceResource,
        ...
        Object[] values2 = new Object[] { fac.createPoint(new Coordinate(10, 10)), "targetName" }; //$NON-NLS-1$
        ...
        targetMap = MapTests.createNonDynamicMapAndRenderer(targetResource,
                new Dimension(100, 100));
    ...
    public void tearDown() throws Exception {
        FeatureStore<SimpleFeatureType, SimpleFeature> store = sourceResource
                .resolve(FeatureStore.class, null);
    ...
    /**
     * Test method for 'org.locationtech.udig.project.ui.DropFilterAction.perform(Object, Object,
     * IProgressMonitor)'
     */
    @Ignore
    @Test
    public void testPerform() throws Exception {
        ...
        FeatureCollection<SimpleFeatureType, SimpleFeature> features = featureSource
                .getFeatures(layer.getFilter());

        assertEquals(1, features.size());
        SimpleFeature addedFeature = features.features().next();

        assertTrue(((Geometry) addedFeature.getDefaultGeometry())
                .equalsExact((Geometry) sourceFeatures[0].getAttribute("geom2"))); //$NON-NLS-1$
    ...
    public void testLine2Polygon() throws Exception {
        setTarget("targetGeom", "Polygon", builder.safeCreateGeometry(Polygon.class, //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public void testLine2Point() throws Exception {
        setTarget("targetGeom", "Point", builder.safeCreateGeometry(Point.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
        LineString line = builder.safeCreateGeometry(LineString.class, new Coordinate[] {
                new Coordinate(10, 10), new Coordinate(20, 10), new Coordinate(20, 20) });
        setSource("LineString", line); //$NON-NLS-1$

        copyFeatures(Point.class, 1);
        ILayer layer = targetMap.getMapLayers().get(0);
        FeatureIterator<SimpleFeature> iter = layer.getResource(FeatureSource.class, null)
                .getFeatures(layer.getFilter()).features();
        SimpleFeature feature = iter.next();
        iter.close();
        assertEquals(line.getCentroid().getCoordinate(),
    ...
    public void testPolygonWithHole2MultiPolygon() throws Exception {
        setTarget("name2", "MultiPolygon", builder.safeCreateGeometry(MultiPolygon.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));

        LinearRing r1 = builder.safeCreateGeometry(LinearRing.class,
                new Coordinate[] { new Coordinate(0, 0), new Coordinate(10, 0),
                        new Coordinate(10, 10), new Coordinate(0, 10), new Coordinate(0, 0) });
        LinearRing r2 = builder.safeCreateGeometry(LinearRing.class,
                new Coordinate[] { new Coordinate(2, 2), new Coordinate(8, 2), new Coordinate(8, 8),
                        new Coordinate(2, 2), });

        GeometryFactory fac = new GeometryFactory();
        Polygon poly = fac.createPolygon(r1, new LinearRing[] { r2 });
        setSource("Polygon", poly); //$NON-NLS-1$
    ...
    public void testPolygonWithHole2MultiLine() throws Exception {
        setTarget("name2", "MultiLineString", builder.safeCreateGeometry(MultiLineString.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
    ...
    public void testPoint2Polygon() throws Exception {
        setTarget("name2", "Polygon", builder.safeCreateGeometry(Polygon.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
    ...
    private void setTarget(String name, String type, Geometry geomValue) throws Exception {
        targetType = DataUtilities.createType("target2", "*" + name + ":" + type); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        SimpleFeature[] targetFeatures = new SimpleFeature[1];
        Object[] values = new Object[] { geomValue };
        targetFeatures[0] = SimpleFeatureBuilder.build(targetType, values, "id"); //$NON-NLS-1$
        targetResource = CatalogTests.createGeoResource(targetFeatures, true);
        targetMap = MapTests.createNonDynamicMapAndRenderer(targetResource,
                new Dimension(100, 100));
        FeatureStore<SimpleFeatureType, SimpleFeature> store = targetResource
                .resolve(FeatureStore.class, null);
        store.removeFeatures(Filter.INCLUDE);
    }
    ...
    public void testPoint2Line() throws Exception {
        ...
        setTarget("name2", "LineString", builder.safeCreateGeometry(LineString.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
    ...
    public void testLine2MultiLine() throws Exception {
        setTarget("target2", "MultiLineString", builder.safeCreateGeometry(MultiLineString.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
    ...
    public void testPolygon2LineString() throws Exception {
        setTarget("target2", "LineString", builder.safeCreateGeometry(LineString.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
        LinearRing r1 = builder.safeCreateGeometry(LinearRing.class,
                new Coordinate[] { new Coordinate(0, 0), new Coordinate(10, 0),
                        new Coordinate(10, 10), new Coordinate(0, 10), new Coordinate(0, 0) });
    ...
    public void testPoint2LinearRing() throws Exception {
        ...
        setTarget("name2", "org.locationtech.jts.geom.LinearRing", builder //$NON-NLS-1$ //$NON-NLS-2$
                .safeCreateGeometry(LinearRing.class, new Coordinate[] { new Coordinate(10, 10) }));
    ...
    public void testPolygon2LinearRing() throws Exception {
        setTarget("target2", "org.locationtech.jts.geom.LinearRing", builder //$NON-NLS-1$ //$NON-NLS-2$
                .safeCreateGeometry(LinearRing.class, new Coordinate[] { new Coordinate(10, 10) }));
        LinearRing r1 = builder.safeCreateGeometry(LinearRing.class,
                new Coordinate[] { new Coordinate(0, 0), new Coordinate(10, 0),
                        new Coordinate(10, 10), new Coordinate(0, 10), new Coordinate(0, 0) });
    ...
    private void setSource(String type, Geometry attribute) throws Exception {
        sourceType = DataUtilities.createType("source2", "*geom:" + type + ",nAme:String"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        sourceFeatures = new SimpleFeature[1];
        Object[] values = new Object[] { attribute, "sourceName" }; //$NON-NLS-1$
    ...
    public void testPolygon2Point() throws Exception {
        setTarget("name2", "Point", builder.safeCreateGeometry(Point.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));

        Polygon poly = builder.safeCreateGeometry(Polygon.class,
                new Coordinate[] { new Coordinate(0, 0), new Coordinate(10, 0),
        ...
        SimpleFeature feature = iter.next();
        iter.close();
        assertEquals(poly.getCentroid().getCoordinate(),
                ((Geometry) feature.getDefaultGeometry()).getCoordinate());
    }
    ...
    public void testMultiPolygon2Point() throws Exception {
        ...
        Polygon poly = builder.safeCreateGeometry(Polygon.class,
                new Coordinate[] { new Coordinate(0, 0), new Coordinate(10, 0),
                        new Coordinate(10, 10), new Coordinate(0, 0), });
        Polygon poly2 = builder.safeCreateGeometry(Polygon.class,
                new Coordinate[] { new Coordinate(10, 10), new Coordinate(20, 10),
                        new Coordinate(20, 20), new Coordinate(10, 10), });
        GeometryFactory fac = new GeometryFactory();
        setSource("MultiPolygon", fac.createMultiPolygon(new Polygon[] { poly, poly2 })); //$NON-NLS-1$
        ...
        FeatureIterator<SimpleFeature> iter = layer.getResource(FeatureSource.class, null)
                .getFeatures(layer.getFilter()).features();
        SimpleFeature feature = iter.next();
        assertTrue(poly.getCentroid().getCoordinate()
                .equals(((Geometry) feature.getDefaultGeometry()).getCoordinate())
                || poly2.getCentroid().getCoordinate()
                        .equals(((Geometry) feature.getDefaultGeometry()).getCoordinate()));
        feature = iter.next();
        assertTrue(poly.getCentroid().getCoordinate()
                .equals(((Geometry) feature.getDefaultGeometry()).getCoordinate())
    ...
    public void testMultiPolygon2MultiPoint() throws Exception {
        setTarget("name2", "MultiPoint", builder.safeCreateGeometry(MultiPoint.class, //$NON-NLS-1$ //$NON-NLS-2$
                new Coordinate[] { new Coordinate(10, 10) }));
    ...
    public void testMultiPolygonWithHole2LineString() throws Exception {
        ...
        GeometryFactory fac = new GeometryFactory();
        Polygon poly = fac.createPolygon(r1, new LinearRing[] { r2 });
        setSource("MultiPolygon", fac.createMultiPolygon(new Polygon[] { poly })); //$NON-NLS-1$
        ...
        SimpleFeature feature = iter.next();
        assertTrue(
                r1.equals(feature.getDefaultGeometry()) || r2.equals(feature.getDefaultGeometry()));
        feature = iter.next();
        assertTrue(
                r1.equals(feature.getDefaultGeometry()) || r2.equals(feature.getDefaultGeometry()));
        iter.close();
    ...
    public void testMultiPolygonWithHole2Polygon() throws Exception {
        ...
        GeometryFactory fac = new GeometryFactory();
        Polygon poly = fac.createPolygon(r1, new LinearRing[] { r2 });
        setSource("MultiPolygon", fac.createMultiPolygon( //$NON-NLS-1$
                new Polygon[] { poly, fac.createPolygon(r2, new LinearRing[0]) }));
    ...
    public void testMultiLineString2MultiPolygon() throws Exception {
        ...
        LineString poly = builder.safeCreateGeometry(LineString.class,
                new Coordinate[] { new Coordinate(0, 0), new Coordinate(10, 0),
                        new Coordinate(10, 10), new Coordinate(0, 0), });
        LineString poly2 = builder.safeCreateGeometry(LineString.class,
                new Coordinate[] { new Coordinate(10, 10), new Coordinate(20, 10),
                        new Coordinate(20, 20), new Coordinate(10, 10), });
        GeometryFactory fac = new GeometryFactory();
        setSource("MultiLineString", fac.createMultiLineString(new LineString[] { poly, poly2 })); //$NON-NLS-1$

        copyFeatures(MultiPolygon.class, 2);
    }

    private void copyFeatures(Class<? extends Geometry> type, int expectedFeatures)
        ...
        FeatureIterator<SimpleFeature> iter = featureSource.getFeatures(layer.getFilter())
                .features();
        SimpleFeature feature = iter.next();
        iter.close();
    ...
    public void testPointToGeomDragDrop() throws Exception {
        ...
        SimpleFeature[] targetFeatures = new SimpleFeature[1];
        targetFeatures[0] = SimpleFeatureBuilder.build(targetType, new Object[] { null }, "id"); //$NON-NLS-1$
        targetResource = CatalogTests.createGeoResource(targetFeatures, true);
        targetMap = MapTests.createNonDynamicMapAndRenderer(targetResource,
                new Dimension(100, 100));
    ...
    /**
     * Test method for
     * 'org.locationtech.udig.project.internal.commands.edit.CopyFeaturesCommand.rollback(
     * IProgressMonitor)'
     */
    @Ignore
    @Test
