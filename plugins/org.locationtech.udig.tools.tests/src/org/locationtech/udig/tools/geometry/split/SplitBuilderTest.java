...
public class SplitBuilderTest {
    ...
    public void testBuilder2Steps() throws Exception {
        ...
        Geometry inputGeometry1 = (Geometry) SplitTestUtil
                .read("POLYGON ((5 35, 35 35, 35 10, 5 10, 5 35))");
        Geometry inputGeometry2 = (Geometry) SplitTestUtil
                .read("POLYGON ((35 35, 50 35, 50 10, 35 10, 35 35))");
        ...
        Geometry partC = SplitTestUtil
                .read(" POLYGON ((35 35, 50 35, 50 10, 35 10, 35 25, 35 35))");
