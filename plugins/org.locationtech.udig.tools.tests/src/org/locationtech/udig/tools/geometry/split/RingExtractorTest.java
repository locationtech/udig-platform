...
public class RingExtractorTest {
    ...
    /**
     * Test method for {@link es.axios.lib.geometry.split.RingExtractor#processExtraction()}.
     */
    @Test
    public void testProcessExtraction0() throws Exception {
        ...
        Geometry partB = SplitTestUtil
                .read("LINEARRING (100 120, 100 90, 190 90, 190 120, 100 120)");

        Geometry partC = SplitTestUtil
                .read("LINESTRING (30 180, 100 180, 100 120, 30 120, 30 180)");
    ...
    public void testProcessExtraction1() throws Exception {
        ...
        Geometry partB = SplitTestUtil
                .read("LINESTRING (100 200, 150 200, 150 130, 100 130, 100 200)");

        Geometry partC = SplitTestUtil
                .read("LINESTRING (300 200, 300 130, 230 130, 230 200, 300 200)");
    ...
    public void testProcessExtraction2() throws Exception {
        ...
        Geometry partC = SplitTestUtil
                .read("LINESTRING (170 190, 210 190, 210 160, 170 160, 170 190)");
    ...
    public void testProcessExtraction3() throws Exception {
        ...
        Geometry partA = SplitTestUtil
                .read("LINESTRING (250 270, 250 150, 110 150, 110 180, 90 180)");

        Geometry partB = SplitTestUtil
                .read("LINESTRING (170 220, 210 220, 210 190, 170 190, 170 220)");

        Geometry partC = SplitTestUtil
                .read("LINESTRING (130 240, 170 240, 170 220, 130 220, 130 240)");

        Geometry partD = SplitTestUtil
                .read("LINESTRING (110 220, 130 220, 130 180, 110 180, 110 220)");
    ...
    public void testProcessExtraction4() throws Exception {
        ...
        LineString line = (LineString) SplitTestUtil
                .read("LINESTRING (110 260, 280 260, 280 150, 110 150, 110 260)");
    ...
    public void testProcessExtraction5() throws Exception {
        ...
        LineString line = (LineString) SplitTestUtil
                .read("LINESTRING (150 260, 270 260, 270 180, 160 180, 160 270)");

        Geometry partA = SplitTestUtil.read("LINESTRING (160 270, 160 260, 150 260)");

        Geometry partB = SplitTestUtil
                .read("LINESTRING (160 180, 160 260, 270 260, 270 180, 160 180)");
    ...
    public void testEndLineFinishOnEdge() throws Exception {
        ...
        Geometry partA = SplitTestUtil
                .read("LINESTRING (260 280, 260 140, 130 140, 130 190, 150 190)");

        Geometry partB = SplitTestUtil
                .read("LINESTRING (90 220, 130 220, 130 190, 90 190, 90 220)");

        Geometry partC = SplitTestUtil
                .read("LINESTRING (150 220, 180 220, 180 190, 150 190, 150 220)");

        Geometry partD = SplitTestUtil
                .read("LINESTRING (240 190, 240 160, 150 160, 150 190, 240 190)");

        Geometry partE = SplitTestUtil
                .read("LINESTRING (180 280, 240 280, 240 220, 180 220, 180 280)");
    ...
    public void testEndLineFinishOnEdge2Rings() throws Exception {
        ...
        Geometry partB = SplitTestUtil
                .read("LINESTRING (180 110, 240 110, 240 70, 180 70, 180 110)");

        Geometry partC = SplitTestUtil
                .read("LINESTRING (130 110, 180 110, 180 70, 130 70, 130 110)");
    ...
    public void testLineOverLine() throws Exception {
        ...
        Geometry partA = SplitTestUtil
                .read("LINESTRING (110 280, 260 280, 260 210, 110 210, 110 280)");

        Geometry partB = SplitTestUtil
                .read("LINESTRING (110 330, 110 280, 110 210, 110 80, 240 80)");
