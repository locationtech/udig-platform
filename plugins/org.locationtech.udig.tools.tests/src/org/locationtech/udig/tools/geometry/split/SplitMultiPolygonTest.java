...
public class SplitMultiPolygonTest {
    /**
     * This test case belongs to the document: splitissues_A.pdf. The input data has been changed to
     * be valid. It has been split into 2 geometries. This test behold the first geometry.
     * 
     * @throws Exception
     */
    @Test
    public void testSzenario_A_inputChanged_1() throws Exception {
        MultiPolygon splitee = (MultiPolygon) SplitTestUtil
                .read("MULTIPOLYGON (((0 0, 5 0, 5 10, 0 10, 0 8, 3 8, 3 6, 0 6, 0 0)))"); //$NON-NLS-1$
        ...
        Geometry partA = SplitTestUtil
                .read("POLYGON ((5 2.6666666666666665, 3 6, 0 6, 0 0, 5 0, 5 2.6666666666666665))"); // A //$NON-NLS-1$
        Geometry partB = SplitTestUtil
                .read("POLYGON ((5 8.666666666666666, 3 8, 3 6, 5 2.6666666666666665, 5 8.666666666666666))"); //$NON-NLS-1$
        Geometry partC = SplitTestUtil
                .read("POLYGON ((3 8, 0 8, 0 10, 5 10, 5 8.666666666666666, 3 8))"); //$NON-NLS-1$
        // wrong polygon
        // Geometry partD =
    ...
    /**
     * This test case belongs to the document: splitissues_A.pdf. The input data has been changed to
     * be valid. It has been split into 2 geometries. This test behold the second geometry.
     * 
     * @throws Exception
     */
    @Test
    public void testSzenario_A_inputChanged_2() throws Exception {
        MultiPolygon splitee = (MultiPolygon) SplitTestUtil
                .read("MULTIPOLYGON (((0 6, 3 6, 3 8, 0 8, 0 6)))"); //$NON-NLS-1$
    ...
    /**
     * This test case belongs to the document: splitissues_0203_20100324.pdf. Case 2. The input data
     * has been changed to be valid. It has been split into 2 geometries. This test behold the first
     * geometry.
     * 
     * @throws Exception
     */
    ...
    public void testSzenario_002_withValidData_1() throws Exception {
        MultiPolygon splitee = (MultiPolygon) SplitTestUtil
                .read("MULTIPOLYGON(((1 1, 1 8, 10 8, 10 1, 1 1),(2 3, 8 3, 8 6, 2 6, 2 3)))"); //$NON-NLS-1$
        ...
        Geometry partA = SplitTestUtil
                .read("POLYGON ((1 1, 1 8, 10 8, 10 1, 1 1), (5 3, 8 3, 8 6, 2 6, 2 3, 2 2, 5 2, 5 3))"); //$NON-NLS-1$
    ...
    /**
     * This test case belongs to the document: splitissues_0203_20100324.pdf. Case 2. The input data
     * has been changed to be valid.It has been split into 2 geometries. This test behold the second
     * geometry.
     * 
     * @throws Exception
     */
    ...
    public void testSzenario_002_withValidData_2() throws Exception {
        MultiPolygon splitee = (MultiPolygon) SplitTestUtil
                .read("MULTIPOLYGON (((2 3, 8 3, 8 6, 2 6, 2 3)))"); //$NON-NLS-1$
    ...
    /**
     * This test case belongs to the document: splitissues_0203_20100324.pdf Case 3.
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * This test case belongs to the document: splitissues_0203_20100324.pdf. Case 3. The input data
     * has been changed to be valid. It has been split into 2 geometries. This test behold the first
     * geometry.
     * 
     * @throws Exception
    ...
    /**
     * This test case belongs to the document: splitissues_0203_20100324.pdf. Case 3. The input data
     * has been changed to be valid. It has been split into 2 geometries. This test behold the
     * second geometry.
     * 
     * @throws Exception
     */
