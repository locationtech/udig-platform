...
//
    ...
    public Map<String,Serializable> getParams() {
        ...
        try {
            ...
            r.put(WFSDataStoreFactory.URL.key,u);
        } catch (Exception e) {
            if(red == null)
...
//        }
        ...
        if(postDefault.getSelection()){
            r.put(WFSDataStoreFactory.PROTOCOL.key,Boolean.TRUE);
        }else{
            if(getDefault.getSelection()){
                r.put(WFSDataStoreFactory.PROTOCOL.key,Boolean.FALSE);
            }else{
                r.put(WFSDataStoreFactory.PROTOCOL.key,null);
            }
        }
        ...
        if(!WFSRegistryWizardPage.timeoutDefault.equals(timeout)){
            ...
            r.put(WFSDataStoreFactory.TIMEOUT.key,new Integer(sec.intValue()*1000));
        }
        ...
        if(!WFSRegistryWizardPage.bufferDefault.equals(buffer)){
            ...
            r.put(WFSDataStoreFactory.BUFFER_SIZE.key,sec);
        }
