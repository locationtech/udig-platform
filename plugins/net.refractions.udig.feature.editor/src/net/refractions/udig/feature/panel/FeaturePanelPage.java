...
public class FeaturePanelPage extends Page implements ILabelProviderListener, ISelectionListener {
    ...
    /**
     * This is used to communicate a selected SimpleFeatureType to the page. This can be used
     * adapt a normal workbench part up as a IFeaturePanelPageContributor.
     */
            ...
            if (descriptor == null) {
                ...
                if (tabComposite == null) {
                    ...
                    try {
                        ...
                        IStatus status = new Status( IStatus.ERROR, descriptor.getEntry().getId(), "Problem initializing feature panel", e );
     ...
     * @since 3.5
     */
    public FeaturePanelPage(
            FeaturePanelPageContributor contributor,
    ...
    private void initContributor( SimpleFeatureType schema ) {
        ...
        if (currentSchema == schema ) {
            ...
            registry = FeaturePanelRegistryFactory.getInstance().createRegistry(selectionContributor);
        }
    ...
    protected void updateTabs( List<FeaturePanelTabDescriptor> descriptors ) {
        Map<FeaturePanelTabDescriptor,IFeaturePanel> newTabs = new HashMap<FeaturePanelTabDescriptor,IFeaturePanel> (descriptors.size() * 2);
    ...
    private void setInput( IWorkbenchPart part, ISelection selection ) {
        ...
        List<FeaturePanelTabDescriptor> descriptors = registry.getTabDescriptors(part, currentSelection);
    ...
    /**
     * Retrieve the contributor from the selection; the contributor is responsible for obtaining a Schema.
     * 
    ...
    private FeaturePanelPageContributor getFeaturePanelPageContributor( Object object ) {
        ...
        if (Platform.getAdapterManager().hasAdapter(object,
            ...
            return (FeaturePanelPageContributor) Platform.getAdapterManager().loadAdapter(
                    object, FeaturePanelPageContributor.class.getName());
        }
     ...
     * ITabbedFeaturePanelPageContributor which is unique contributor id. This unique contributor
     * id is used to load a registry with the extension point This id matches the registry.
     * <p>
     * It is possible for elements in a selection to implement ITabbedFeaturePanelPageContributor
    ...
    private void validateRegistry( ISelection selection ) {
        ...
        while( i.hasNext() ) {
            ...
            if (newContributor == null
                    || !newContributor.getSchema().equals(selectionSchema)) {
                /**
