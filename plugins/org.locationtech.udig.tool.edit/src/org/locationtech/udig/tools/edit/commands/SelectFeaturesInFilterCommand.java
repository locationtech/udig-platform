...
public class SelectFeaturesInFilterCommand extends AbstractCommand implements UndoableMapCommand {
    ...
    public void run(IProgressMonitor monitor) throws Exception {
        ...
        Query query = new Query(layer.getSchema().getTypeName(), filter, desiredProperties);
        ...
        try {
            ...
            for (UndoableMapCommand command : commands) {
                ...
                index += inc;
                SubMonitor subMonitor = SubMonitor.convert(monitor, (int) index);
    ...
    public void rollback(IProgressMonitor monitor) throws Exception {
        ...
        for (int i = commands.size() - 1; i > -1; i--) {
            ...
            commands.get(i).rollback(subMonitor);
            subMonitor.done();
        }
        monitor.done();
    }
