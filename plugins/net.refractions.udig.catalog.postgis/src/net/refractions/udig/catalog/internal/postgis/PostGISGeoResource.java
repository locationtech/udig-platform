 ...
 * @since 0.6
 */
public class PostGISGeoResource extends IGeoResource {
    PostGISServiceImpl parent;
	...
	private PostGISGeoResource() {/* not for use */
    }
    /**
     ...
     * @param typename
     */
    public PostGISGeoResource( PostGISServiceImpl parent, String typename ) {
        this.parent = parent;
    ...
    class PostGISResourceInfo extends IGeoResourceInfo {
        ...
        PostGISResourceInfo() throws IOException {
            ...
            try {
                ...
                message=e;
                PostgisPlugin.log("Unable to retrieve FeatureType schema for type '"+typename+"'.", e); //$NON-NLS-1$ //$NON-NLS-2$
