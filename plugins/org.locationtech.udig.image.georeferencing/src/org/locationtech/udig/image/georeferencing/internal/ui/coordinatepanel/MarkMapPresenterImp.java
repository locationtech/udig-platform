...
final class MarkMapPresenterImp extends AbstractMarkPresenter implements MarkMapPresenter {
     ...
     *
     * @param markModel The mark model.
     */
    ...
    /**
     * Manages the event seeing if the given x,y is contained by the presenter extent.
     *
     ...
     *
     * @param feedback True if the presenter needs to show its feedback.
     */
    @Override
