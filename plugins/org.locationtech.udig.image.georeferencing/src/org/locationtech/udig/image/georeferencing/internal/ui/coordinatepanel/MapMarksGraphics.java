...
public final class MapMarksGraphics implements MapGraphic {
    ...
    private Map<String, MarkMapPresenter> markMapPresenterList = Collections
            .synchronizedMap(new Hashtable<String, MarkMapPresenter>());

    private MarkMapPreview preview = null;

    private Set<MouseSelectionListener> listeners = new HashSet<>();
     ...
     *
     * @param coordComposite {@link CoordinateTableComposite}.
     * @param imageComposite {@link ImageComposite}.
     */
    public void associateListeners(CoordinateTableComposite coordComposite,
     ...
     * @param imageComposite {@link ImageComposite}.
     */
    public void deleteAssociatedListeners(CoordinateTableComposite coordComposite,
            ImageComposite imageComposite) {
     ...
     * (non-Javadoc)
     *
     * @see org.locationtech.udig.mapgraphic.MapGraphic#draw(org.locationtech.udig.
     ...
     *
     * @param markPresenter A map presenter.
     */
     ...
     * @param point Point related to the map.
     */
    ...
    /**
     * Shows the feedback and broadcast which mark is getting affected by the feedback to the
     * listeners.
     *
     * @param inputEvent Input event.
     * @param x Map position.
     * @param y Map position.
     */
    ...
    /**
     * Broadcast to all the listeners that the given mark is under the mouse position.
     *
    ...
    /**
     * Broadcast to all the listeners that the given mark is not under the mouse position.
     *
     * @param mark The mark model.
     */
    ...
    /**
     * Find the given mark inside the list of {@link MarkMapPresenterImp}s and shows the feedback.
     *
     * @param mark The mark model.
     */
    ...
    /**
     * Find the given mark inside the list of {@link MarkMapPresenterImp}s and establish to not show
     * the feedback.
     *
     * @param mark The mark model.
     */
