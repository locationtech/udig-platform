...
public class ServiceParameterPersisterTest {
    ...
    private void assertPersistance(TestService service)
            throws BackingStoreException, IOException, MalformedURLException {
    ...
    class TestPersister extends ServiceParameterPersister {
        ...
        public TestPersister() {
            super(CatalogPlugin.getDefault().getLocalCatalog(),
