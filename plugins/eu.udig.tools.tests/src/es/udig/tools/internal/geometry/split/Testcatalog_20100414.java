 ...
 */
package es.udig.tools.internal.geometry.split;
...
import eu.udig.tools.internal.geometry.split.SplitUtil;
...
public class Testcatalog_20100414 {
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((90 250, 170 250, 170 190, 90 190, 90 250))"); //$NON-NLS-1$
    ...
    /**
     * Source: The feature that will suffer the split operation is a Polygon
     * feature with a hole.
     * 
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((90 190, 120 190, 120 180, 90 180, 90 190))"); //$NON-NLS-1$
    ...
    /**
     * Source: There are 2 polygon features but only one of them will suffer the
     * split operation.
     * 
     * Result: 2 Polygon features.
     * 
    ...
    /**
     * Source: There are 2 polygon features but only one of them will suffer the
     * split operation. This feature also has 2 holes.
     * 
     * Result: 2 Polygon features.
     * 
     * @throws Exception
    ...
    /**
     * Source: There are at least 2 polygon features, one feature has 2 holes
     * and the other feature is inside one off those holes.
     * 
     * Result: The first feature is divided into 2 features and his 2 holes
     * became into 1 hole. The second feature is divided into 2 features.
     * 
     * @throws Exception
     */
    @Test
	...
	Geometry partC = SplitTestUtil
		.read(" POLYGON ((160 230, 160 210, 170 220, 160 230))"); //$NON-NLS-1$
	...
	SplitTestUtil.testSplitStrategy(secondPolygon, splitLine,
		expectedParts2);
    }
	...
	SplitTestUtil.testSplitStrategy(polygon, splitLine,
		emptyList);
    }
	...
	List<Geometry> resultList = new LinkedList<Geometry>();
	resultList.add(SplitTestUtil.read("POLYGON ((-41.0771000003442 337768.4178, -42.71 337769.61, -44.1661000000313 337768.4178, -41.0889999996871 337768.4178, -41.0771000003442 337768.4178))")); //$NON-NLS-1$
	resultList.add(SplitTestUtil.read("POLYGON ((-44.2330999998376 337771.5067, -42.5944999996573 337771.543099999, -41.2114000003785 337771.573899999, -41.1517000002787 337770.171399999, -41.0771000003442 337768.4178, -42.71 337769.61, -44.1661000000313 337768.4178, -44.1929999999702 337769.658399999, -44.2330999998376 337771.5067))")); //$NON-NLS-1$
     ...
     * 
     * Result: The first feature is divided into 3 features and one off his
     * holes disappear.
     * 
     * @throws Exception
     */
    ...
    /**
     * Source: There are 2 polygon features, one of them with one hole. This
     * feature will suffer the split operation.
     * 
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((190 100, 200 110, 190 120, 190 100))"); //$NON-NLS-1$
     ...
     * feature will suffer the split operation.
     * 
     * Result: The feature will be divided into 2 features and its hole will
     * disappear.
     * 
     * @throws Exception
     */
    ...
    /**
     * Source: There are at least 1 Polygon feature with 3 holes and inside
     * those holes there could be some Polygon features (1-5).
     * 
     * Result: The feature with the holes will suffer the split operation and it
     * will be divided into 2 Polygon features.
     * 
     * @throws Exception
     */
    @Test
     ...
     * 
     * Result: The feature with the holes will suffer the split operation and it
     * will be divided into 3 Polygon features.
     * 
     * @throws Exception
     */
    @Test
     ...
     * 
     * Result: 2 features will be divided into 5 polygon features and the other
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((75 100, 115 100, 115 60, 75 60, 75 100))"); //$NON-NLS-1$
	...
	Geometry partE = SplitTestUtil
		.read("POLYGON ((115 60, 140 60, 140 25, 115 25, 115 60))"); //$NON-NLS-1$
    ...
    /**
     * Source: There are 4 Polygon features. One of then has a hole and inside
     * it lies one of the source polygon feature.
     * 
     * Result: The feature that has a hole will be divided into 5 polygon
     * features and the others remains untouched.
     * 
     * @throws Exception
     */
    @Test
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((150 20, 150 40, 170 20, 170 20, 150 20))"); //$NON-NLS-1$
	Geometry partC = SplitTestUtil
		.read("POLYGON ((70 90, 70 70, 80 90, 80 90, 70 90))"); //$NON-NLS-1$
	Geometry partD = SplitTestUtil
		.read("POLYGON ((150 160, 130 160, 150 140, 150 160))"); //$NON-NLS-1$
	Geometry partE = SplitTestUtil
     ...
     * it lies one of the source polygon feature.
     * 
     * Result: The feature that has a hole will be divided into 3 polygon
     * features and the others remains untouched.
     * 
     * @throws Exception
     */
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((70 90, 80 90, 70 70, 70 90))"); //$NON-NLS-1$
	Geometry partC = SplitTestUtil
     ...
     * it lies one of the source polygon feature.
     * 
     * Result: The feature that has a hole will be divided into 4 polygon
     * features and the others remains untouched.
     * 
     * @throws Exception
     */
	...
	expectedParts.add(SplitTestUtil
		.read(" POLYGON ((70 70, 70 90, 80 90, 70 70))")); //$NON-NLS-1$
	expectedParts.add(SplitTestUtil
		.read("POLYGON ((150 160, 90 160, 150 140, 150 160))")); //$NON-NLS-1$
	expectedParts
		.add(SplitTestUtil
			.read(" POLYGON ((180 190, 210 190, 210 20, 150 20, 150 40, 70 70, 80 90, 150 140, 180 140, 180 190))")); //$NON-NLS-1$
    ...
    /**
     * Source: There is one polygon feature with 3 holes. (there could be
     * features inside those holes)
     * 
     * Result: The feature will be divided into 3 polygon features. (If there
     * would be 2 features inside the lower holes, those features inside the
     * holes would also be divided, each one would be divided into 2.)
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * Source: There is one polygon feature with 3 holes. (there could be
     * feature/s inside those holes)
     * 
     * Result: The feature will be divided into 3 polygon features. (If there
     * would be one feature inside the upper hole, that feature inside the hole
     * would also be divided into 3 features).
     * 
     * @throws Exception
     */
    @Test
     ...
     * features inside those holes)
     * 
     * Result: The feature will be divided into 2 polygon features. (If there
     * would be 2 features inside the lower holes, those features inside the
     * holes would also be divided, each one would be divided into 2.)
     * 
     * @throws Exception
    ...
    /**
     * Source: There is one Polygon feature entirely surrounded by 2 Polygon
     * features.
     * 
     * Result: The feature will be divided into 2 Polygon features.
     * 
	...
	LineString splitLine = (LineString) SplitTestUtil
		.read("LINESTRING (120 130, 160 100)"); //$NON-NLS-1$
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((160 130, 160 100, 120 130, 160 130))"); //$NON-NLS-1$
     ...
     * 
     * Result: One feature will be divided into 2 Polygon features, the other
     * remains intact.
     * 
     * @throws Exception
     */
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((90 70, 90 110, 160 110, 160 70, 90 70))"); //$NON-NLS-1$
	...
	LineString splitLine = (LineString) SplitTestUtil.read("LINESTRING (70 90, 90 70, 160 70, 180 50)"); //$NON-NLS-1$

	Polygon polygon = (Polygon) SplitTestUtil
		.read("POLYGON ((30 160, 30 40, 220 40, 220 160, 190 160, 190 70, 160 70, 160 110, 90 110, 90 70, 60 70, 60 160, 60 160, 30 160))"); //$NON-NLS-1$

	List<Geometry> expectedParts = new ArrayList<Geometry>();
	expectedParts.add(SplitTestUtil.read("POLYGON ((90 70, 160 70, 190 70, 190 160, 220 160, 220 40, 30 40, 30 160, 60 160, 60 70, 90 70, 90 70))")); //$NON-NLS-1$);
    ...
    /**
     * Like 32 a but the split line start and end in the vertex shared by the
     * polygons.
     * 
     * @throws Exception
     */
	...
	List<Geometry> expectedParts = new ArrayList<Geometry>();
	expectedParts.add(SplitTestUtil.read("POLYGON ((462.842600000091 338094.383199999, 458.32880000025 338099.2083, 456.276200000197 338101.2609, 456.201600000262 338101.3355, 457.674599999562 338102.760199999, 459.248499999754 338104.282500001, 458.579499999993 338104.923599999, 457.342899999581 338106.1087, 453.403400000185 338102.2171, 448.834300000221 338097.7037, 449.043899999931 338097.488700001, 451.54629999958 338094.922499999, 460.372600000352 338085.8708, 460.498200000264 338085.742000001, 461.026700000279 338085.199999999, 461.053100000136 338085.227, 463.059100000188 338087.2805, 466.095499999821 338090.388800001, 468.649699999951 338093.0035, 469.794800000265 338094.1757, 468.959300000221 338094.976299999, 468.464999999851 338095.449999999, 465.07349999994 338092.1523, 462.842600000091 338094.383199999))")); //$NON-NLS-1$
	expectedParts.add(SplitTestUtil.read("POLYGON ((458.32880000025 338099.2083, 459.366299999878 338100.2459, 460.143299999647 338099.469, 464.087799999863 338095.524599999, 462.842600000091 338094.383199999, 458.32880000025 338099.2083))")); //$NON-NLS-1$
	...
	Geometry partB = SplitTestUtil
		.read("POLYGON ((70 90, 180 90, 180 60, 70 60, 70 90))"); //$NON-NLS-1$
    ...
    /**
     * Source: There are 2 Polygon features. One has a hole and the other lies
     * inside that hole.
     * 
     * Result: The feature with the hole will be split into 5 features and the
     * other feature will also be split into 5 features.
     * 
     * @throws Exception
     */
    @Test
	...
	Geometry partB = SplitTestUtil
		.read(" POLYGON  ((90 120, 90 100, 80 110, 90 120))"); //$NON-NLS-1$
	Geometry partC = SplitTestUtil
		.read(" POLYGON ((100 90, 120 90, 110 80, 100 90))"); //$NON-NLS-1$
	Geometry partD = SplitTestUtil
		.read(" POLYGON ((130 100, 130 120, 140 110, 130 100))"); //$NON-NLS-1$
	Geometry partE = SplitTestUtil
		.read(" POLYGON ((100 130, 120 130, 110 140, 100 130))"); //$NON-NLS-1$
	...
	Geometry partG = SplitTestUtil
		.read(" POLYGON ((90 100, 100 90, 90 90, 90 100))"); //$NON-NLS-1$
	Geometry partH = SplitTestUtil
		.read(" POLYGON ((120 90, 130 100, 130 90, 120 90))"); //$NON-NLS-1$
	Geometry partI = SplitTestUtil
		.read(" POLYGON ((90 130, 100 130, 90 120, 90 130))"); //$NON-NLS-1$
	Geometry partJ = SplitTestUtil
		.read(" POLYGON ((120 130, 130 130, 130 120, 120 130))"); //$NON-NLS-1$
	...
	List<Geometry> expectedParts = new ArrayList<Geometry>();
	Geometry partE = SplitTestUtil
		.read("POLYGON ((140 100, 140 80, 120 80, 140 100))"); //$NON-NLS-1$
	Geometry partF = SplitTestUtil
		.read("POLYGON ((120 140, 140 140, 140 120, 120 140))"); //$NON-NLS-1$
	Geometry partG = SplitTestUtil
    ...
    /**
     * Test 36b: Exterior Polygon with a hole that contains the polygon tested
     * 36a
     * 
     * @throws Exception
     */
	...
	Geometry partD = SplitTestUtil
		.read(" POLYGON ((140 100, 150 110, 140 120, 140 100))"); //$NON-NLS-1$
	...
	SplitTestUtil.testSplitStrategy(polygonToSplit, splitLine,
		expectedParts);
    }
     ...
     * 
     * Result: Each feature will be divided into 2 Polygon features, so the
     * total features will be 8.
     * 
     * @throws Exception
     */
    @Test
	...
	expectedParts2.add(partD);
	SplitTestUtil
		.testSplitStrategy(geomToSplit2, splitLine, expectedParts2);

	List<Geometry> expectedParts3 = new ArrayList<Geometry>();
	expectedParts3.add(partE);
	expectedParts3.add(partF);
	SplitTestUtil
		.testSplitStrategy(geomToSplit3, splitLine, expectedParts3);

	List<Geometry> expectedParts4 = new ArrayList<Geometry>();
	expectedParts4.add(partG);
	expectedParts4.add(partH);
	SplitTestUtil
		.testSplitStrategy(geomToSplit4, splitLine, expectedParts4);
    }

    /**
     * Two polygons (testcatalog 40a and 40b) that share a boundary. The split
     * line cross the boundary in zigzag way. (Reported by wien
     * issue_20100825.png)
     * 
     * @throws Exception
     */
    ...
    /**
     * Split line snap on the boundaries of the polygon to split and further on
     * the corners of an inner polygon
     * 
    ...
    /**
     * Split line that intersect with the interior of a polygon with hole but
     * the split strategy can not produce an split result.
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * this is like 43 changing the split line to an split line with oposite
     * direction
     * 
     * @throws Exception
     */
	...
	SplitTestUtil
		.testSplitStrategy(geomToSplit1, splitLine, expectedPieces);
    }
	...
	expectedParts1.add(SplitTestUtil
		.read("POLYGON ((720 160, 740 185, 740 144, 720 160))")); //$NON-NLS-1$
