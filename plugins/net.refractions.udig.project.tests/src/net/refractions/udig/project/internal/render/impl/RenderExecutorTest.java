...
public class RenderExecutorTest extends AbstractProjectTestCase {
	...
	protected void setUp() throws Exception {
		...
		Feature[] features=UDIGTestUtil.createTestFeatures("testType", new Geometry[]{poly1, poly2},new String[]{},  //$NON-NLS-1$
		...
		Style style=sb.createStyle(features[0].getFeatureType().getTypeName(), sb.createPolygonSymbolizer(Color.BLACK,Color.BLACK, 1));
