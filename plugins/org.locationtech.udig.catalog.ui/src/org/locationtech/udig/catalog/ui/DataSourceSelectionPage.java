 ...
 *      setSelectedDescriptor(UDIGImportPageDescriptor). All other methods are wizard lifecycle
 *      methods.page
 *      </p>
 * @author Justin Deoliveira,Refractions Research Inc.,jdeolive@refractions.net
 */
public class DataSourceSelectionPage extends WorkflowWizardPage
    ...
    public DataSourceSelectionPage() {
        ...
        setImageDescriptor(CatalogUIPlugin.imageDescriptorFromPlugin(CatalogUIPlugin.ID,
                "icons/wizban/add_wiz.gif")); //$NON-NLS-1$
    }

    /**
     * Sets the selected set of import page descriptors.
     *
     * @param ids A list of import page identifiers.
     *
     */
     ...
     *
     * @param id The id of the import page to select.
     */
     ...
     * Sets the selected import page descriptor.
     *
     * @param descriptor The descriptor to be selected.
     */
    public void setSelection(List<UDIGConnectionFactoryDescriptor> descriptors) {
        ...
        if (viewer != null) {
            ...
            if (!selected.isEmpty()) {
                viewer.setSelection(new StructuredSelection(selected.getFirstElement()));
            } else {
    ...
    public List<UDIGConnectionFactoryDescriptor> getDescriptors() {
        List<UDIGConnectionFactoryDescriptor> connectionFactoryDescriptors = ConnectionFactoryManager
                .instance().getConnectionFactoryDescriptors();
