...
public class DummyView extends ViewPart {
    ...
    public static final String VIEW_ID = "org.locationtech.udig.catalog.tests.ui.workflow.DummyView"; //$NON-NLS-1$
    ...
    private void showMessage(String message) {
        MessageDialog.openInformation(viewer.getControl().getShell(), "DummyView", //$NON-NLS-1$
                message);
    }
