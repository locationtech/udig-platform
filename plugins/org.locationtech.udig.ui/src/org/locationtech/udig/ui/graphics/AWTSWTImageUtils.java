...
public final class AWTSWTImageUtils {
    ...
    public static ImageData createImageData(BufferedImage image) {
        ...
        if (image.getType() == BufferedImage.TYPE_3BYTE_BGR) {
            ...
            ImageData data = new ImageData(width, height, depth, paletteData, width * bands,
                    pixels);
            return data;
     ...
     * {@link SWTGraphics#createSWTImage(BufferedImage, int, int)}.
     *
     * @param image source image.
     * @param width the width of the final image
     * @param height the height of the final image
    ...
    public static ImageData createImageData(RenderedImage image) {
        ...
        ImageData data = new ImageData(width, height, depth,
                new PaletteData(0xff0000, 0x00ff00, 0x0000ff), width, pixels);
        return data;
    }

    public static java.awt.Color swtColor2awtColor(GC gc, Color swt) {
        java.awt.Color awt = new java.awt.Color(swt.getRed(), swt.getGreen(), swt.getBlue(),
                gc.getAlpha());
        return awt;
    }
    ...
    public static ImageDescriptor awtIcon2ImageDescriptor(final Icon icon) {
        ImageDescriptor descriptor = new ImageDescriptor() {
            ...
            @Override
            public ImageData getImageData() {
                BufferedImage image = createBufferedImage(icon.getIconWidth(),
                        icon.getIconHeight());
