...
public class FeatureTextTransfer extends AbstractTextStrategizedTransfer implements UDIGTransfer {
    ...
    public String[] getStrategyNames() {
        return new String[] { Messages.FeatureTextTransfer_strategy_gml_name,
                Messages.FeatureTextTransfer_strategy_wkt_name };
    }
    ...
    public static class JtsWktStrategy implements TransferStrategy {
        ...
        public Object nativeToJava(TransferData transferData) {
            ...
            try {
                ...
                SimpleFeatureType ft = DataUtilities.createType("Temp Type", //$NON-NLS-1$
                        "*geom:" + read.getClass().getName()); //$NON-NLS-1$
