...
public class PointPropertiesEditor extends PropertiesEditor {
    ...
    private void createRulesButtons( Composite rulesGroup ) {
        ...
        upButton.setToolTipText("Move group or rule up");
    ...
    private void createStyleButtons( Composite rulesGroup ) {
        ...
        saveAllButton.setToolTipText("Save all groups and rules as style");
        ...
        importButton.setToolTipText("Import supported files to style");
