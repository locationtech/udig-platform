...
import net.refractions.udig.project.ui.internal.MapEditorWithPalettePart;
 ...
 * @author Andrea Aime
 */
public class ScaleRatioLabelPalette extends ContributionItem implements KeyListener, FocusListener {
    ...
    private final MapEditorWithPalettePart mapPart;
    ...
    public ScaleRatioLabelPalette(MapEditorWithPalettePart editor) {
        super(SCALE_ITEM_ID);
        this.mapPart = editor;
    }
