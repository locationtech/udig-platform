...
public class TrackingGraphic implements MapGraphic {
    ...
    public static final String LISTENER_BLACKBOARD_KEY =
        "org.locationtech.udig.tutorials.tracking.TrackingItemListenerImpl"; //$NON-NLS-1$

    public static final String NEEDSREFRESH_BLACKBOARD_KEY =
        "org.locationtech.udig.tutorials.tracking.TrackingItemListenerImpl"; //$NON-NLS-1$

    public static final String REFRESHJOB_BLACKBOARD_KEY =
