...
public class IssuesViewTest extends AbstractProjectUITestCase {
    ...
    public void setUp() throws Exception {
        ...
        view = (IssuesView) PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage()
    ...
    public void testIconsAndText() throws Exception {
        ...
        Display.getDefault().syncExec(new Runnable() {
            ...
            public void run() {
                ...
                assertEquals(p.getColumnImage(list.get(0), IssuesView.PRIORITY_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.PRIORITY_CRITICAL));
                assertEquals(p.getColumnImage(list.get(1), IssuesView.PRIORITY_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.PRIORITY_HIGH));
                assertEquals(p.getColumnImage(list.get(2), IssuesView.PRIORITY_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.PRIORITY_LOW));
                assertEquals(p.getColumnImage(list.get(3), IssuesView.PRIORITY_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.PRIORITY_TRIVIAL));
                assertEquals(p.getColumnImage(list.get(4), IssuesView.PRIORITY_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.PRIORITY_WARNING));
                ...
                assertEquals(p.getColumnImage(list.get(0), IssuesView.RESOLUTION_COLUMN),
                        IssuesActivator.getDefault()
                                .getImage(ImageConstants.RESOLUTION_UNRESOLVED));
                assertEquals(p.getColumnImage(list.get(1), IssuesView.RESOLUTION_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.RESOLUTION_VIEWED));
                assertEquals(p.getColumnImage(list.get(2), IssuesView.RESOLUTION_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.RESOLUTION_RESOLVED));
                assertEquals(p.getColumnImage(list.get(3), IssuesView.RESOLUTION_COLUMN),
                        IssuesActivator.getDefault().getImage(ImageConstants.RESOLUTION_UNKNOWN));
                assertEquals(p.getColumnImage(list.get(4), IssuesView.RESOLUTION_COLUMN),
                        IssuesActivator.getDefault()
                                .getImage(ImageConstants.RESOLUTION_UNRESOLVED));
                ...
                // name text
                assertEquals("problem" + Priority.CRITICAL, //$NON-NLS-1$
                        p.getColumnText(list.get(0), IssuesView.OBJECT_COLUMN));
                assertEquals("problem" + Priority.HIGH, //$NON-NLS-1$
                        p.getColumnText(list.get(1), IssuesView.OBJECT_COLUMN));
                assertEquals("problem" + Priority.LOW, //$NON-NLS-1$
                        p.getColumnText(list.get(2), IssuesView.OBJECT_COLUMN));
                assertEquals("problem" + Priority.TRIVIAL, //$NON-NLS-1$
                        p.getColumnText(list.get(3), IssuesView.OBJECT_COLUMN));
                assertEquals("problem" + Priority.WARNING, //$NON-NLS-1$
                        p.getColumnText(list.get(4), IssuesView.OBJECT_COLUMN));
                // desc text
                assertEquals("desc" + Priority.CRITICAL, //$NON-NLS-1$
                        p.getColumnText(list.get(0), IssuesView.DESC_COLUMN));
                assertEquals("desc" + Priority.HIGH, //$NON-NLS-1$
                        p.getColumnText(list.get(1), IssuesView.DESC_COLUMN));
                assertEquals("desc" + Priority.LOW, //$NON-NLS-1$
                        p.getColumnText(list.get(2), IssuesView.DESC_COLUMN));
                assertEquals("desc" + Priority.TRIVIAL, //$NON-NLS-1$
                        p.getColumnText(list.get(3), IssuesView.DESC_COLUMN));
                assertEquals("desc" + Priority.WARNING, //$NON-NLS-1$
                        p.getColumnText(list.get(4), IssuesView.DESC_COLUMN));
            }
        });
    ...
    public void testSorterChange() throws Exception {
        Display.getDefault().syncExec(new Runnable() {
            ...
            public void run() {
                ...
                viewer.getTree().getColumn(IssuesView.RESOLUTION_COLUMN)
                ...
                // test resolution sorting
                viewer.getTree().getColumn(IssuesView.PRIORITY_COLUMN)
                        .notifyListeners(SWT.Selection, new Event());
                ordering(viewer, 0, 1);
                viewer.getTree().getColumn(IssuesView.PRIORITY_COLUMN)
                        .notifyListeners(SWT.Selection, new Event());
                ...
                // test name sorting
                viewer.getTree().getColumn(IssuesView.OBJECT_COLUMN).notifyListeners(SWT.Selection,
                        new Event());
                ordering(viewer, 0, 1);
                viewer.getTree().getColumn(IssuesView.OBJECT_COLUMN).notifyListeners(SWT.Selection,
                        new Event());
                ...
                // test desc sorting
                viewer.getTree().getColumn(IssuesView.DESC_COLUMN).notifyListeners(SWT.Selection,
                        new Event());
                ordering(viewer, 0, 1);
                viewer.getTree().getColumn(IssuesView.DESC_COLUMN).notifyListeners(SWT.Selection,
                        new Event());
    ...
    public void testShowFixedIssues() throws Exception {
        ...
        assertEquals(view.forTestingGetResolvedIssues().get(0),
                ((Tree) viewer.getControl()).getItem(0).getData());
    ...
    public void testCloseView() throws Exception {
        ...
        try {
            IIssuesManager.defaultInstance.setIssuesList(
                    IssuesListTestHelper.createInMemoryDatastoreIssuesList(null, null));
    ...
    public void testRefreshAction() throws Exception {
        ...
        try {
            IIssuesManager.defaultInstance.setIssuesList(
                    IssuesListTestHelper.createInMemoryDatastoreIssuesList(null, null));
            IRemoteIssuesList list = (IRemoteIssuesList) IIssuesManager.defaultInstance
                    .getIssuesList();
    ...
    public void testSetLabelProvider() throws Exception {
        ...
        assertEquals(TestLabelProvider.Provider1.HEADERTEXT,
                view.forTestingGetProblemObjectColumnHeader().getText());
        ...
        assertEquals(TestLabelProvider.Provider2.HEADERTEXT,
                view.forTestingGetProblemObjectColumnHeader().getText());
    ...
    public void testInit() throws Exception {
        IPreferenceStore preferenceStore = IssuesActivator.getDefault().getPreferenceStore();
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_CONTENT_PROVIDER,
                "org.locationtech.udig.issues.test.TestContentProvider"); //$NON-NLS-1$
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_SORTER,
                "org.locationtech.udig.issues.test.TestSorter"); //$NON-NLS-1$
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_EXPANSION_PROVIDER,
                "org.locationtech.udig.issues.test.TestContentProvider"); //$NON-NLS-1$
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_LABEL_PROVIDER,
                "org.locationtech.udig.issues.test.TestLabelProvider"); //$NON-NLS-1$
        ...
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_CONTENT_PROVIDER,
                "randomNonsense value"); //$NON-NLS-1$
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_LABEL_PROVIDER,
                "randomNonsense value"); //$NON-NLS-1$
        preferenceStore.setValue(PreferenceConstants.KEY_VIEW_EXPANSION_PROVIDER,
                "randomNonsense value"); //$NON-NLS-1$
