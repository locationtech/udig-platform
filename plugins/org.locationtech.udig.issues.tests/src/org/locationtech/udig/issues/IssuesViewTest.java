...
public class IssuesViewTest extends AbstractProjectUITestCase {
    public class TestIssueContentProvider implements IIssuesContentProvider {
        private String parent= "parent";//$NON-NLS-1$
...
//    }
    ...
    public void testSetExpansionProvider() throws Exception {
        viewer.setSelection(new StructuredSelection());
        view.setContentProvider(new TestIssueContentProvider());
    ...
    @Test
    public void testDoAutoExpandIfLevelOnViewerIsSetToALL_LEVELS() {
    ...
    @Test
    public void testDoNotAutoExpandIfDisabledOnViewer() {
    ...
    @Test
    public void testDoAutoExpandIfLevelOnViewerIsGreaterThan0() {
