 ...
 */
package org.locationtech.udig.jconsole.internal.ui;
...
public class RunningProcessListDialog {
    ...
    public void open( Shell parentShell, final int selectionType ) {
        ...
        runningProcessesMap = JConsolePlugin.getDefault().getRunningProcessesMap();
        ...
        dialog = new Dialog(parentShell){
            ...
            protected void buttonPressed( int buttonId ) {
                if (buttonId == OK) {
                    JConsolePlugin.getDefault().killProcess(currentSelectedProcessId);
                }
