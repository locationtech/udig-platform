...
public class JConsoleScriptExecutor {
    ...
    public JConsoleScriptExecutor() throws Exception {
        /*
         * get java exec
         */
        javaFile = JConsolePlugin.getApplicationJava();
         ...
         * get libraries
         */
        String classpathJars = JConsolePlugin.getDefault().getClasspathJars();
    ...
    public Process exec( String script, final PrintStream internalStream, final PrintStream errorStream, String loggerLevelGui,
        ...
        if (loggerLevelGui == null)
            loggerLevelGui = JConsoleConstants.LOGLEVEL_GUI_OFF;
        ...
        // modules jars
        // TODO : define extension point to handle external modules
        /** 
        ...
        **/
        // grass gisbase
        // TODO : create an extension point to register additional parameters for scripting
        /**
        ...
        */
        ...
        internalStream.println("Process started: " + new DateTime().toString(JConsoleConstants.dateTimeFormatterYYYYMMDDHHMMSS));
        internalStream.println("");

        // command launched
        if (loggerLevelGui.equals(JConsoleConstants.LOGLEVEL_GUI_ON)) {
        ...
        new Thread(){
            public void run() {
                ...
                internalStream.println("Process finished: "
                        + new DateTime().toString(JConsoleConstants.dateTimeFormatterYYYYMMDDHHMMSS));
            };
        }.start();
