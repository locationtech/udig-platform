...
public abstract class RendererImpl extends EObjectImpl implements Renderer {
	...
	public String getName() {
		if (name == null) {
			...
			if (layer instanceof SelectionLayer)
				return MessageFormat.format(Messages.RendererImpl_selectionFor, new Object[] { layer.getName() });
			else
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RenderPackage.RENDERER__NAME, oldName, name));
	}
	...
	public void setState(int newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RenderPackage.RENDERER__STATE, oldState, state));
	}
	 ...
	 */
	@Override
	public abstract void render(Graphics2D destination, IProgressMonitor monitor) throws RenderException;
	...
	public synchronized void setRenderBounds(Rectangle screenArea) {
		...
		Coordinate max = getContext().pixelToWorld(screenArea.width + screenArea.x, screenArea.height + screenArea.y);
