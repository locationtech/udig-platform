...
public class FolderImpl extends EObjectImpl implements Folder {
	...
	public List<ILegendItem> getItems() {
		if (items == null) {
			items = new EObjectContainmentEList<ILegendItem>(ILegendItem.class, this, ProjectPackage.FOLDER__ITEMS);
		}
		return items;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.FOLDER__NAME, oldName, name));
	}
	...
	public void setIcon(ImageDescriptor newIcon) {
		...
		icon = newIcon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.FOLDER__ICON, oldIcon, icon));
	}
	...
	public void setShown(boolean newShown) {
		...
		shown = newShown;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.FOLDER__SHOWN, oldShown, shown));
	}
