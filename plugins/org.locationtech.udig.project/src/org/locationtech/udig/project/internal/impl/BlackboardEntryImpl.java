...
public class BlackboardEntryImpl extends EObjectImpl implements BlackboardEntry {
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.BLACKBOARD_ENTRY__KEY, oldKey, key));
	}
	...
	public void setMemento(String newMemento) {
		...
		memento = newMemento;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.BLACKBOARD_ENTRY__MEMENTO, oldMemento,
					memento));
	}
