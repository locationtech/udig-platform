...
public class EditManagerImpl extends EObjectImpl implements EditManager {
	...
	public NotificationChain basicSetMapInternal(Map newMapInternal, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newMapInternal, ProjectPackage.EDIT_MANAGER__MAP_INTERNAL, msgs);
		return msgs;
	}
	...
	public void setMapInternal(Map newMapInternal) {
		if (newMapInternal != eInternalContainer()
			...
			if (newMapInternal != null)
				msgs = ((InternalEObject) newMapInternal).eInverseAdd(this, ProjectPackage.MAP__EDIT_MANAGER_INTERNAL,
						Map.class, msgs);
			msgs = basicSetMapInternal(newMapInternal, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.EDIT_MANAGER__MAP_INTERNAL,
	...
	public void setEditFeature(SimpleFeature feature, Layer layer) {
		...
		if (isEditLayerLocked() && (layer != editLayerInternal && editLayerInternal != null)) {
			throw new IllegalArgumentException("Edit Layer is locked so argument 'layer' should be not be changed."); //$NON-NLS-1$
		}
		...
		eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.EDIT_MANAGER__EDIT_FEATURE, oldFeature,
				value));
	}
		...
		try {
			...
			try {
				...
				FeatureCollection<SimpleFeatureType, SimpleFeature> results = source
						.getFeatures(filterFactory.id(FeatureUtils.stringToId(filterFactory, editFeature.getID())));
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case ProjectPackage.EDIT_MANAGER__MAP_INTERNAL:
			return eInternalContainer().eInverseRemove(this, ProjectPackage.MAP__EDIT_MANAGER_INTERNAL, Map.class,
					msgs);
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ProjectPackage.EDIT_MANAGER__EDIT_FEATURE:
			return EDIT_FEATURE_EDEFAULT == null ? editFeature != null : !EDIT_FEATURE_EDEFAULT.equals(editFeature);
		case ProjectPackage.EDIT_MANAGER__MAP_INTERNAL:
	...
	public void setSelectedLayerGen(Layer newSelectedLayer) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.EDIT_MANAGER__SELECTED_LAYER,
					oldSelectedLayer, selectedLayer));
	}
	...
	Adapter eventCreator = new AdapterImpl() {
		...
		public void notifyChanged(Notification msg) {
			...
			case ProjectPackage.EDIT_MANAGER__EDIT_FEATURE:
				fireEvent(new EditManagerEvent(EditManagerImpl.this, EditManagerEvent.EDIT_FEATURE, msg.getNewValue(),
						msg.getOldValue()));
				break;
			case ProjectPackage.EDIT_MANAGER__EDIT_LAYER_INTERNAL:
				fireEvent(new EditManagerEvent(EditManagerImpl.this, EditManagerEvent.EDIT_LAYER, msg.getNewValue(),
						msg.getOldValue()));
				break;
			case ProjectPackage.EDIT_MANAGER__SELECTED_LAYER:
				fireEvent(new EditManagerEvent(EditManagerImpl.this, EditManagerEvent.SELECTED_LAYER, msg.getNewValue(),
						msg.getOldValue()));
				break;
			default:
				break;
	...
	public void setEditLayerLocked(boolean newEditLayerLocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.EDIT_MANAGER__EDIT_LAYER_LOCKED,
					oldEditLayerLocked, editLayerLocked));
	}
