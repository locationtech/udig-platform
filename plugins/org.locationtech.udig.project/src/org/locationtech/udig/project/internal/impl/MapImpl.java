...
public class MapImpl extends EObjectImpl implements Map {
		...
		if (projectInternal != null && projectInternal.eIsProxy()) {
			...
			if (projectInternal != oldProjectInternal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProjectPackage.MAP__PROJECT_INTERNAL,
	...
	public void setProjectInternal(Project newProjectInternal) {
		if (newProjectInternal != projectInternal) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__PROJECT_INTERNAL,
	...
	public void setContextModelGen(ContextModel newContextModel) {
		if (newContextModel != contextModel) {
			NotificationChain msgs = null;
			if (contextModel != null)
				msgs = ((InternalEObject) contextModel).eInverseRemove(this, ProjectPackage.CONTEXT_MODEL__MAP,
						ContextModel.class, msgs);
			if (newContextModel != null)
				msgs = ((InternalEObject) newContextModel).eInverseAdd(this, ProjectPackage.CONTEXT_MODEL__MAP,
						ContextModel.class, msgs);
			msgs = basicSetContextModel(newContextModel, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__CONTEXT_MODEL, newContextModel,
					newContextModel));
	}
	...
	public NotificationChain basicSetViewportModelInternal(ViewportModel newViewportModelInternal,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ProjectPackage.MAP__VIEWPORT_MODEL_INTERNAL, oldViewportModelInternal, newViewportModelInternal);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setViewportModelInternalGen(ViewportModel newViewportModelInternal) {
		if (newViewportModelInternal != viewportModelInternal) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__VIEWPORT_MODEL_INTERNAL,
	...
	public void setColorPalette(BrewerPalette newColorPalette) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__COLOR_PALETTE, oldColorPalette,
					colorPalette));
	}
	...
	public void setAbstract(String newAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__ABSTRACT, oldAbstract,
					abstract_));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__NAME, oldName, name));
	}
	...
	public ReferencedEnvelope getBounds(IProgressMonitor monitor) {
		if (getLayersInternal() != null) {
			...
			for (Layer layer : layers) {
				...
				bbox = layer.getBounds(ProgressManager.instance().get(), getViewportModel().getCRS());
				if (!bbox.isNull()) {
					if (bounds.isNull())
		...
		for (GeographicExtent extent2 : elems) {
			...
			if (extent2 instanceof GeographicBoundingBox) {
				...
				for (Geometry geometry : polygons) {
					...
					env = new ReferencedEnvelope(envelope.getMinimum(0), envelope.getMaximum(0), envelope.getMinimum(1),
							envelope.getMaximum(1), envelope.getLowerCorner().getCoordinateReferenceSystem());
					break;
				}
			}
	...
	public void setLayerFactory(LayerFactory newLayerFactory) {
		if (newLayerFactory != layerFactory) {
			NotificationChain msgs = null;
			if (layerFactory != null)
				msgs = ((InternalEObject) layerFactory).eInverseRemove(this, ProjectPackage.LAYER_FACTORY__MAP,
						LayerFactory.class, msgs);
			if (newLayerFactory != null)
				msgs = ((InternalEObject) newLayerFactory).eInverseAdd(this, ProjectPackage.LAYER_FACTORY__MAP,
						LayerFactory.class, msgs);
			msgs = basicSetLayerFactory(newLayerFactory, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__LAYER_FACTORY, newLayerFactory,
					newLayerFactory));
	}
	...
	private void notifyCommandStackChange() {
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__COMMAND_STACK, null,
					commandManager));
	}

	private void notifyNavCommandStackChange() {
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__NAV_COMMAND_STACK, null,
					navCommandManager));
	}
	...
	void notifyBatchNotification(int featureID, int eventType) {
		if (eNotificationRequired()) {
			...
			for (Layer layer : getContextModel().getLayers()) {
				...
				ENotificationImpl notification = new ENotificationImpl((InternalEObject) layer, eventType, featureID,
						null, layer.eGet(feature));
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ProjectPackage.MAP__VIEWPORT_MODEL_INTERNAL:
			if (viewportModelInternal != null)
				msgs = ((InternalEObject) viewportModelInternal).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ProjectPackage.MAP__VIEWPORT_MODEL_INTERNAL, null, msgs);
		...
		case ProjectPackage.MAP__EDIT_MANAGER_INTERNAL:
			if (editManagerInternal != null)
				msgs = ((InternalEObject) editManagerInternal).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ProjectPackage.MAP__EDIT_MANAGER_INTERNAL, null, msgs);
	...
	public boolean eIsSet(int featureID) {
		...
		case ProjectPackage.MAP__COLOR_PALETTE:
			return COLOR_PALETTE_EDEFAULT == null ? colorPalette != null : !COLOR_PALETTE_EDEFAULT.equals(colorPalette);
		case ProjectPackage.MAP__EDIT_MANAGER_INTERNAL:
	...
	public NotificationChain basicSetEditManagerInternal(EditManager newEditManagerInternal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ProjectPackage.MAP__EDIT_MANAGER_INTERNAL, oldEditManagerInternal, newEditManagerInternal);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setEditManagerInternal(EditManager newEditManagerInternal) {
		if (newEditManagerInternal != editManagerInternal) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__EDIT_MANAGER_INTERNAL,
					newEditManagerInternal, newEditManagerInternal));
	}
	...
	public NotificationChain basicSetRenderManagerInternal(RenderManager newRenderManagerInternal,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ProjectPackage.MAP__RENDER_MANAGER_INTERNAL, oldRenderManagerInternal, newRenderManagerInternal);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setRenderManagerInternalGen(RenderManager newRenderManagerInternal) {
		if (newRenderManagerInternal != renderManagerInternal) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__RENDER_MANAGER_INTERNAL,
	...
	public void setColourScheme(ColourScheme newColourScheme) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__COLOUR_SCHEME, oldColourScheme,
					colourScheme));
	}
	...
	public NotificationChain basicSetBlackBoardInternal(Blackboard newBlackBoardInternal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ProjectPackage.MAP__BLACK_BOARD_INTERNAL, oldBlackBoardInternal, newBlackBoardInternal);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newBlackBoardInternal != blackBoardInternal) {
			...
			if (blackBoardInternal != null)
				msgs = ((InternalEObject) blackBoardInternal).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ProjectPackage.MAP__BLACK_BOARD_INTERNAL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.MAP__BLACK_BOARD_INTERNAL,
					newBlackBoardInternal, newBlackBoardInternal));
	}
	...
	public List<ILegendItem> getLegend() {
		if (legend == null) {
			legend = new EObjectContainmentEList<ILegendItem>(ILegendItem.class, this, ProjectPackage.MAP__LEGEND);
		}
		return legend;
	}
	...
	private Filter target(Layer layer, Filter filter) {
		...
		try {
			FeatureSource<SimpleFeatureType, SimpleFeature> featureSource = layer.getResource(FeatureSource.class,
					null);
