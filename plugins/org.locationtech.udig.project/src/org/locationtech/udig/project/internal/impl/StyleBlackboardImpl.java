			...
			for (Iterator seItr = getContent().iterator(); seItr.hasNext();) {
				...
				if (style instanceof String) {
					...
					try {
						...
						ProjectPlugin.trace(StyleBlackboardImpl.class, "Unable to copy style " + ID + ":" + style, t);
					}
				} else {
					// unable to preserve independence of this style object
					styleEntryClone.setStyle(style); // warning!
					ProjectPlugin.trace(StyleBlackboardImpl.class, "Unable to copy style " + ID + ":" + style, null);
				}
