...
public class RenderPackageImpl extends EPackageImpl implements RenderPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(iMultiLayerRendererEClass, IMultiLayerRenderer.class, "IMultiLayerRenderer", IS_ABSTRACT, //$NON-NLS-1$
		...
		initEClass(multiLayerRendererEClass, MultiLayerRenderer.class, "MultiLayerRenderer", IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);

		EOperation op = addEOperation(multiLayerRendererEClass, null, "refreshImage", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEException(op, this.getRenderException());

		initEClass(renderExecutorEClass, RenderExecutor.class, "RenderExecutor", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRenderExecutor_Renderer(), this.getRenderer(), null, "renderer", null, 1, 1, //$NON-NLS-1$
				RenderExecutor.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(renderManagerEClass, RenderManager.class, "RenderManager", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRenderManager_RenderExecutor(), this.getRenderExecutor(), null, "renderExecutor", null, 0, 1, //$NON-NLS-1$
				RenderManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRenderManager_MapDisplay(), this.getMapDisplay(), "mapDisplay", null, 0, 1, //$NON-NLS-1$
				RenderManager.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getRenderManager_MapInternal(), theProjectPackage.getMap(),
				theProjectPackage.getMap_RenderManagerInternal(), "mapInternal", null, 0, 1, RenderManager.class, //$NON-NLS-1$
				IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getRenderManager_ViewportModelInternal(), this.getViewportModel(),
				this.getViewportModel_RenderManagerInternal(), "viewportModelInternal", null, 0, 1, RenderManager.class, //$NON-NLS-1$
		...
		initEClass(viewportModelEClass, ViewportModel.class, "ViewportModel", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getViewportModel_CRS(), this.getCoordinateReferenceSystem(), "cRS", null, 0, 1, //$NON-NLS-1$
				ViewportModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_Bounds(), this.getReferencedEnvelope(), "bounds", "", 0, 1, ViewportModel.class, //$NON-NLS-1$//$NON-NLS-2$
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_Center(), this.getCoordinate(), "center", null, 0, 1, ViewportModel.class, //$NON-NLS-1$
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_Height(), ecorePackage.getEDouble(), "height", null, 0, 1, ViewportModel.class, //$NON-NLS-1$
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_Width(), ecorePackage.getEDouble(), "width", null, 0, 1, ViewportModel.class, //$NON-NLS-1$
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_AspectRatio(), ecorePackage.getEDouble(), "aspectRatio", null, 0, 1, //$NON-NLS-1$
				ViewportModel.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_PixelSize(), this.getCoordinate(), "pixelSize", null, 0, 1, ViewportModel.class, //$NON-NLS-1$
				IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getViewportModel_MapInternal(), theProjectPackage.getMap(),
				theProjectPackage.getMap_ViewportModelInternal(), "mapInternal", null, 0, 1, ViewportModel.class, //$NON-NLS-1$
				IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getViewportModel_RenderManagerInternal(), this.getRenderManager(),
				this.getRenderManager_ViewportModelInternal(), "renderManagerInternal", null, 0, 1, ViewportModel.class, //$NON-NLS-1$
				IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getViewportModel_PreferredScaleDenominators(), g1, "preferredScaleDenominators", null, 0, 1, //$NON-NLS-1$
				ViewportModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_AvailableTimesteps(), this.getLocalDateTime(), "availableTimesteps", null, 0, //$NON-NLS-1$
				-1, ViewportModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_CurrentTimestep(), this.getLocalDateTime(), "currentTimestep", null, 0, 1, //$NON-NLS-1$
				ViewportModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_AvailableElevation(), ecorePackage.getEDoubleObject(), "availableElevation", //$NON-NLS-1$
				null, 0, -1, ViewportModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getViewportModel_CurrentElevation(), ecorePackage.getEDoubleObject(), "currentElevation", null, //$NON-NLS-1$
				0, 1, ViewportModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(viewportModelEClass, this.getAffineTransform(), "worldToScreenTransform", 0, 1, IS_UNIQUE, //$NON-NLS-1$
				IS_ORDERED);

		op = addEOperation(viewportModelEClass, this.getPoint(), "worldToPixel", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		addEParameter(op, this.getCoordinate(), "coord", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		op = addEOperation(viewportModelEClass, this.getCoordinate(), "pixelToWorld", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		op = addEOperation(viewportModelEClass, this.getViewportModel(), "panUsingScreenCoords", 0, 1, IS_UNIQUE, //$NON-NLS-1$
				IS_ORDERED);
		...
		op = addEOperation(viewportModelEClass, this.getViewportModel(), "panUsingWorldCoords", 0, 1, IS_UNIQUE, //$NON-NLS-1$
				IS_ORDERED);
		...
		op = addEOperation(viewportModelEClass, this.getViewportModel(), "zoom", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$
		...
		initEClass(rendererEClass, Renderer.class, "Renderer", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getRenderer_State(), ecorePackage.getEInt(), "state", "0", 0, 1, Renderer.class, !IS_TRANSIENT, //$NON-NLS-1$//$NON-NLS-2$
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRenderer_Name(), ecorePackage.getEString(), "name", null, 0, 1, Renderer.class, !IS_TRANSIENT, //$NON-NLS-1$
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRenderer_Context(), this.getIRenderContext(), null, "context", null, 0, 1, Renderer.class, //$NON-NLS-1$
				IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(rendererEClass, null, "dispose", 0, 1, IS_UNIQUE, IS_ORDERED); //$NON-NLS-1$

		initEClass(iMapDisplayListenerEClass, IMapDisplayListener.class, "IMapDisplayListener", IS_ABSTRACT, //$NON-NLS-1$
				IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);

		initEClass(iRenderContextEClass, IRenderContext.class, "IRenderContext", IS_ABSTRACT, IS_INTERFACE, //$NON-NLS-1$
				!IS_GENERATED_INSTANCE_CLASS);
		...
		initEDataType(iProgressMonitorEDataType, IProgressMonitor.class, "IProgressMonitor", IS_SERIALIZABLE, //$NON-NLS-1$
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(renderExceptionEDataType, RenderException.class, "RenderException", IS_SERIALIZABLE, //$NON-NLS-1$
				!IS_GENERATED_INSTANCE_CLASS);
		initEDataType(sortedSetEDataType, SortedSet.class, "SortedSet", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
