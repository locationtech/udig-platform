...
public class RenderManagerImpl extends EObjectImpl implements RenderManager {
	...
	public void setMapInternalGen(Map newMapInternal) {
		if (newMapInternal != mapInternal) {
			...
			if (mapInternal != null)
				msgs = ((InternalEObject) mapInternal).eInverseRemove(this, ProjectPackage.MAP__RENDER_MANAGER_INTERNAL,
						Map.class, msgs);
			if (newMapInternal != null)
				msgs = ((InternalEObject) newMapInternal).eInverseAdd(this, ProjectPackage.MAP__RENDER_MANAGER_INTERNAL,
						Map.class, msgs);
			msgs = basicSetMapInternal(newMapInternal, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RenderPackage.RENDER_MANAGER__MAP_INTERNAL,
	...
	public void setMapDisplay(IMapDisplay newMapDisplay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RenderPackage.RENDER_MANAGER__MAP_DISPLAY,
					oldMapDisplay, mapDisplay));
	}
		...
		if (newViewportModelInternal != viewportModelInternal) {
			...
			if (viewportModelInternal != null)
				msgs = ((InternalEObject) viewportModelInternal).eInverseRemove(this,
						RenderPackage.VIEWPORT_MODEL__RENDER_MANAGER_INTERNAL, ViewportModel.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RenderPackage.RENDER_MANAGER__VIEWPORT_MODEL_INTERNAL,
	...
	public void setRenderExecutor(RenderExecutor newRenderExecutor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RenderPackage.RENDER_MANAGER__RENDER_EXECUTOR,
					oldRenderExecutor, renderExecutor));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case RenderPackage.RENDER_MANAGER__MAP_DISPLAY:
			return MAP_DISPLAY_EDEFAULT == null ? mapDisplay != null : !MAP_DISPLAY_EDEFAULT.equals(mapDisplay);
		case RenderPackage.RENDER_MANAGER__MAP_INTERNAL:
