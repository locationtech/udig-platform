...
public class ProjectImpl extends EObjectImpl implements Project {
	...
	public List<ProjectElement> getElementsInternal() {
		if (elementsInternal == null) {
			elementsInternal = new SynchronizedEObjectWithInverseResolvingEList<ProjectElement>(ProjectElement.class,
					this, ProjectPackage.PROJECT__ELEMENTS_INTERNAL, ProjectPackage.PROJECT_ELEMENT__PROJECT_INTERNAL) {
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ProjectPackage.PROJECT__ELEMENTS_INTERNAL:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getElementsInternal()).basicAdd(otherEnd, msgs);
		}
	...
	@SuppressWarnings("unchecked")
	private static void doCreation(ProjectElement projectElement, Resource projectResource, String elementPath,
			String projectPath) {
	...
	private String findElementResourcePath(ProjectElement projectElement, String elementPath2) {
		...
		if (projectElement.eResource() != null) {
			...
			if (Platform.getOS().equals(Platform.OS_WIN32) && elementPath.startsWith(File.separator)) {
				elementPath = elementPath.substring(1);
			}
		}
		return elementPath;
