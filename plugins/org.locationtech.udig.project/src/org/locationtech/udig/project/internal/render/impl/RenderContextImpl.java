 ...
 * <p>
 * This method is responsible for holding on to an Image for a renderer to draw into. A renderer can
 * supply an image; or ask the render context to create one.
 * <p>
 *
 * @author Jesse
 * @since 1.0.0
...
public class RenderContextImpl extends AbstractContextImpl implements RenderContext {
    ...
    public static final BufferedImage dummyImage = new BufferedImage(1, 1,
    ...
    /**
     * For context specific label painters; if null then the label painter on the blackboard is
     * used.
     *
     * @see #getLabelPainter()
    ...
    /**
     * Sets the size of the image. If set to null the size of the image will be the same as the map
     * display.
     *
     * <p>
     * This is used by the tile rendering system to use fixed tile sized images.
     * </p>
     *
     * @param d
     */
    ...
    /**
     * Updates the image associated with the context to point to the new image.
     *
     * @param bi new image
     */
     ...
     * <p>
     * The image will be created if needed; this implementation will make use of the SWT image if it
     * has been previously created with a getSWTImage() and the sizes match.
     * </p>
     *
    ...
    public String toString() {
        ...
        result.append(geoResourceInternal == null ? "null" //$NON-NLS-1$
                : geoResourceInternal.getIdentifier().toString());
        result.append(']');
    ...
    public Query getFeatureQuery() {
        ...
        Object editFilter = getLayer().getBlackboard()
                .get(ProjectBlackboardConstants.MAP__RENDERING_FILTER);
    ...
    public int hashCode() {
        ...
        result = PRIME * result
                + ((geoResourceInternal == null) ? 0 : geoResourceInternal.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (imagesize == null) {
            ...
            if (other.imagesize == null) {
                ...
                if (imagesize.height != other.imagesize.height
                        || imagesize.width != other.imagesize.width) {
                    return false;
                }
            }
        }
     ...
     *
     * <p>
     * This method assumes there is are multiple label painters for the map and this applies only to
     * this context. It is used in the tiled rendering system - each tile has its own label painter.
     * </p>
     * <p>
     ...
     * <p>
     * If the labelPainter is null then it look on the map blackboard for a labelPainter. If it
     * can't find one it creates one and adds it to the map blackboard.
     * </p>
     *
     */
    @Override
    public ILabelPainter getLabelPainter() {
        synchronized (LABEL_PAINTER) {
            ...
            ILabelPainter labelPainter = (ILabelPainter) getMap().getBlackboard()
                    .get(LABEL_PAINTER);
    ...
    /**
     * Sets the label painter to use with the context. This method assumes there is a single label
     * painter for then entire map.
     * <p>
     * This is used to draw the labels for features.
     * </p>
     *
    ...
    /**
     * Returns the size of the image to be generated for display. If imagesize is null then it
     * returns the display size from the map display.
     *
     * <p>
     * This is used by the tile rendering system so a tile can have a fixed size.
     * </p>
     *
     * @return
     */
    ...
    /**
     * Sets the image bounds represented by this context. If set to null then the bounds of the
     * image is assumed to match the bounds of the viewport model.
     */
    @Override
    ...
    /**
     * Converts a coordinate expressed on the image back to real world coordinates.
     *
     * <p>
