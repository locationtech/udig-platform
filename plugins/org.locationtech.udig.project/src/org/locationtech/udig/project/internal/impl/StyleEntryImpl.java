...
public class StyleEntryImpl extends EObjectImpl implements StyleEntry {
	...
	public void setID(String newID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.STYLE_ENTRY__ID, oldID, iD));
	}
	...
	public void setMemento(String newMemento) {
		...
		memento = newMemento;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjectPackage.STYLE_ENTRY__MEMENTO, oldMemento,
					memento));
	}
