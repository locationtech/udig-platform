...
public class NavigationCommandFactory {
    ...
    /**
     * Creates a new {@linkplain PanCommand}Pans the viewport in terms of pixels on the screen. Each
     * pixel represents a distance in world coordinates, the x and y distances differ, so a pan of 8
     * pixels in the x direction will be translated to a pan of 8*xdistance in the world.
     *
