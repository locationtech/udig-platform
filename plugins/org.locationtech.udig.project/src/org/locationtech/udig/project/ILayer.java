...
public interface ILayer extends ILegendItem, Comparable<ILayer> {
     ...
     * <pre>
     * <code>
     * for (IGeoResource resource : getGeoResource()) {
     ...
     *
     * <p>
     * <b>IMPORTANT:</b> unlike using {@link IGeoResource#resolve(Class, IProgressMonitor)}
     * {@link #getResource(Class, IProgressMonitor)} returns the same <em>instance</em> of the
     * resource. The {@link IGeoResource#resolve(Class, IProgressMonitor)} method returns a new
     * instance each time and therefore should <b>NOT</b> be used as a replacement for
     * {@link #getResource(Class, IProgressMonitor)}.
     * </p>
     *
     * @param resourceType
     * @return true if a IGeoResource exists that canResolve to resourceType.
    ...
    /**
     * Returns the ZOrder of the Layer. The Z-Order dictates the order in which the Layer is
     * rendered Low z-orders are rendered first and higher z-orders are rendered on top.
     *
     ...
     * <p>
     * Note: some layers may not ever be applicable for certain toolsets. Sometimes this is can be
     ...
     * </p>
     * <p>
     * This is a helper method to save client code the trouble of hunting down the filter associated
     * with this layer, including any overrides provided by the style blackboard.
     * </p>
     *
