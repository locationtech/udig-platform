...
public class ElementPackageImpl extends EPackageImpl implements ElementPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(projectElementAdapterEClass, ProjectElementAdapter.class, "ProjectElementAdapter", !IS_ABSTRACT, //$NON-NLS-1$
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProjectElementAdapter_BackingObject(), this.getIGenericProjectElement(), "backingObject", //$NON-NLS-1$
				null, 0, 1, ProjectElementAdapter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize data types
		initEDataType(iGenericProjectElementEDataType, IGenericProjectElement.class, "IGenericProjectElement", //$NON-NLS-1$
