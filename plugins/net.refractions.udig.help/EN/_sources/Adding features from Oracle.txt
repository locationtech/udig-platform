...
#. Select Oracle Cannot resolve external resource into attachment. from the list and press **Next**
...
The Oracle server will be added to the Catalog, and the indicated layers will be displayed.
