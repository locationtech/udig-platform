...
public class BasicWMSRenderer2 extends RendererImpl implements IMultiLayerRenderer {
    ...
    private synchronized void render(Graphics2D destination, ReferencedEnvelope bounds,
        ...
        try {
            ...
            /**
             * Put in default exception format we understand as a client (if supported by the
             * server)
             */
    ...
    private void setImageFormat(WebMapServer wms, GetMapRequest request) {
        ...
        /**
         * Select one of the available formats from the WMS server the order of preferred formats is
     ...
     * last request on the layer blackboard for this internal module communication.
     *
     * @return SRS code
     */
