	...
	protected void addRendererPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_RenderExecutor_renderer_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RenderExecutor_type"), //$NON-NLS-1$
						RenderPackage.Literals.RENDER_EXECUTOR__RENDERER, true, false, true, null, null, null));
	}
