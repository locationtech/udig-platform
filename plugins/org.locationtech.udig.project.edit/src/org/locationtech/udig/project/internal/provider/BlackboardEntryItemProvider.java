 ...
 * @generated
 */
public class BlackboardEntryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMementoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BlackboardEntry_memento_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_BlackboardEntry_type"), //$NON-NLS-1$
	...
	protected void addObjectClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BlackboardEntry_objectClass_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_BlackboardEntry_type"), //$NON-NLS-1$
	...
	protected void addObjectPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_BlackboardEntry_object_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_BlackboardEntry_type"), //$NON-NLS-1$
