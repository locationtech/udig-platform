...
public class LayerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addZorderPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ProjectPackage.eINSTANCE.getLayer_Zorder(), true, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_name_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_iD_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addVisiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_visible_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_filter_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_status_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addCRSPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_cRS_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addMinScaleDenominatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_minScaleDenominator_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Layer_type"), //$NON-NLS-1$
	...
	protected void addMaxScaleDenominatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_maxScaleDenominator_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_Layer_type"), //$NON-NLS-1$
	...
	protected void addShownPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_shown_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addIconPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Layer_icon_feature", "_UI_Layer_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public void notifyChanged(Notification notification) {
		...
		case ProjectPackage.LAYER__ZORDER:
			fireNotifyChanged(
					new ViewerNotification(notification, ((ILayer) notification.getNotifier()).getMap(), true, false));
			return;
	...
	public Color getBackground(Object element) {
		if (element instanceof LayerImpl) {
			...
			if (highlightPref.equals(PreferenceConstants.P_HIGHLIGHT_FOREGROUND)) {
				...
				return new Color(PlatformUI.getWorkbench().getDisplay(), awtColor.getRed(), awtColor.getGreen(),
						awtColor.getBlue());
			}
		}
		return null;
	...
	public Color getForeground(Object element) {
		if (element instanceof LayerImpl) {
			...
			if (awtColor == null)
				return null;
			if (highlightPref.equals(PreferenceConstants.P_HIGHLIGHT_FOREGROUND)) {
				return new Color(PlatformUI.getWorkbench().getDisplay(), (int) mylarEffect * awtColor.getRed(),
						(int) mylarEffect * awtColor.getGreen(), (int) mylarEffect * awtColor.getBlue());
			} else if (highlightPref.equals(PreferenceConstants.P_HIGHLIGHT_BACKGROUND)) {
				if (awtColor.getRed() + awtColor.getGreen() + awtColor.getBlue() > 512) {
					...
					return new Color(PlatformUI.getWorkbench().getDisplay(), (int) mylarEffect * 255,
