 ...
 * @generated
 */
public class EditManagerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addEditFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_EditManager_editFeature_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_EditManager_type"), //$NON-NLS-1$
	...
	protected void addEditLayerInternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_EditManager_editLayerInternal_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_EditManager_type"), //$NON-NLS-1$
				ProjectPackage.Literals.EDIT_MANAGER__EDIT_LAYER_INTERNAL, false, false, false, null, null, null));
	}
	...
	protected void addTransactionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_EditManager_transactionType_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_EditManager_type"), //$NON-NLS-1$
	...
	protected void addEditLayerLockedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_EditManager_editLayerLocked_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_EditManager_type"), //$NON-NLS-1$
	...
	protected void addSelectedLayerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_EditManager_selectedLayer_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_EditManager_type"), //$NON-NLS-1$
						ProjectPackage.Literals.EDIT_MANAGER__SELECTED_LAYER, true, false, true, null, null, null));
	}
