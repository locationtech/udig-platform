 ...
 * @generated NOT
 */
public class ProjectItemProvider extends AbstractLazyLoadingItemProvider implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ProjectPackage.eINSTANCE.getProject_Name(), true, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected Collection<? extends Object> getConcreteChildren(Object object) {
		if (object instanceof IProject) {
			List<IProjectElement> elements = new ArrayList<IProjectElement>(((IProject) object).getElements());
			return elements;
		}
