 ...
 * @generated
 */
public class RenderManagerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMapDisplayPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_RenderManager_mapDisplay_feature", //$NON-NLS-1$//$NON-NLS-2$
	...
	protected void addMapInternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_RenderManager_mapInternal_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RenderManager_type"), //$NON-NLS-1$
						RenderPackage.Literals.RENDER_MANAGER__MAP_INTERNAL, true, false, true, null, null, null));
	}
	...
	protected void addViewportModelInternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_RenderManager_viewportModelInternal_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_RenderManager_type"), //$NON-NLS-1$
				RenderPackage.Literals.RENDER_MANAGER__VIEWPORT_MODEL_INTERNAL, true, false, true, null, null, null));
	}
	...
	protected void addRenderExecutorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_RenderManager_renderExecutor_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_RenderManager_type"), //$NON-NLS-1$
						RenderPackage.Literals.RENDER_MANAGER__RENDER_EXECUTOR, true, false, true, null, null, null));
	}
