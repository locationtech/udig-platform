 ...
 * @generated NOT
 */
public class MapItemProvider extends AbstractLazyLoadingItemProvider implements IEditingDomainItemProvider,
	...
	private static class ViewportModelDescriptor implements IItemPropertyDescriptor {
		...
		public boolean isCompatibleWith(Object object, Object anotherObject,
			...
			return element.isCompatibleWith(getModel(object), anotherObject, anotherPropertyDescriptor);
		}
	...
	private void addViewportModelDescriptors(Map map) {
		for (Iterator iter = modelProvider.getPropertyDescriptors(map.getViewportModel()).iterator(); iter.hasNext();) {
	...
	protected void addAbstractPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						ProjectPackage.eINSTANCE.getMap_Abstract(), true, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected ChildFetcher createChildFetcher() {
		return new ChildFetcher(this) {
			...
			protected void notifyChanged() {
				MapItemProvider.this.notifyChanged(new ENotificationImpl((InternalEObject) parent, Notification.SET,
