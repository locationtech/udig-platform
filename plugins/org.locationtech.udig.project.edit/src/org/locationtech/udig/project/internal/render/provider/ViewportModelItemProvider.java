 ...
 * @generated
 */
public class ViewportModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addCenterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_center_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ViewportModel_type"), //$NON-NLS-1$
				RenderPackage.eINSTANCE.getViewportModel_Center(), false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE));
	}
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_height_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ViewportModel_type"), //$NON-NLS-1$
				RenderPackage.eINSTANCE.getViewportModel_Height(), false, ItemPropertyDescriptor.REAL_VALUE_IMAGE));
	}
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(new ItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_width_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ViewportModel_type"), //$NON-NLS-1$
				RenderPackage.eINSTANCE.getViewportModel_Width(), false, ItemPropertyDescriptor.REAL_VALUE_IMAGE));
	}
	...
	protected void addAspectRatioPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_aspectRatio_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ViewportModel_type"), //$NON-NLS-1$
	...
	protected void addPixelSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_pixelSize_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ViewportModel_type"), //$NON-NLS-1$
	...
	protected void addRenderManagerInternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_renderManagerInternal_feature", //$NON-NLS-1$//$NON-NLS-2$
						"_UI_ViewportModel_type"), //$NON-NLS-1$
				RenderPackage.Literals.VIEWPORT_MODEL__RENDER_MANAGER_INTERNAL, true, false, true, null, null, null));
	}
	...
	protected void addPreferredScaleDenominatorsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ViewportModel_preferredScaleDenominators_feature"), //$NON-NLS-1$
						getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
								"_UI_ViewportModel_preferredScaleDenominators_feature", "_UI_ViewportModel_type"), //$NON-NLS-1$ //$NON-NLS-2$
						RenderPackage.Literals.VIEWPORT_MODEL__PREFERRED_SCALE_DENOMINATORS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAvailableTimestepsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_availableTimesteps_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ViewportModel_type"), //$NON-NLS-1$
	...
	protected void addCurrentTimestepPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_currentTimestep_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ViewportModel_type"), //$NON-NLS-1$
	...
	protected void addAvailableElevationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_availableElevation_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ViewportModel_type"), //$NON-NLS-1$
	...
	protected void addCurrentElevationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_ViewportModel_currentElevation_feature", //$NON-NLS-1$//$NON-NLS-2$
								"_UI_ViewportModel_type"), //$NON-NLS-1$
