 ...
 * <ul>
 * <li>{@link org.locationtech.udig.printing.model.impl.ElementImpl#getLocation
 * <em>Location</em>}</li>
 * <li>{@link org.locationtech.udig.printing.model.impl.ElementImpl#getSize <em>Size</em>}</li>
 * <li>{@link org.locationtech.udig.printing.model.impl.ElementImpl#getPaperSize <em>Paper
 * Size</em>}</li>
 * </ul>
 * </p>
 *
...
public class ElementImpl extends EObjectImpl implements Element {
    ...
    public void setLocation(Point newLocation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ELEMENT__LOCATION,
    ...
    public void setSize(Dimension newSize) {
        ...
        size = newSize;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ELEMENT__SIZE,
                    oldSize, size));
    }
    ...
    public void setPaperSize(Dimension newPaperSize) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ELEMENT__PAPER_SIZE,
    ...
    public boolean eIsSet(int featureID) {
        ...
        case ModelPackage.ELEMENT__PAPER_SIZE:
            return PAPER_SIZE_EDEFAULT == null ? paperSize != null
                    : !PAPER_SIZE_EDEFAULT.equals(paperSize);
        }
    ...
    public String toString() {
        ...
        result.append(MessageFormat.format(Messages.ElementImpl_0 + Messages.ElementImpl_toString,
                new Object[] { location, size }));
