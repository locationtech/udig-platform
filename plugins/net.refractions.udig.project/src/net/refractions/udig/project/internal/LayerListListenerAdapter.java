...
/**
 * An Adapter for the List of Layers maintained by a Map (formally ContextModel) that allow other objects to listen to state changes that occur in
 ...
 * <pre>
 * <code>
 * map.getDeepAdapters().add(new LayerListListenerAdapter(){
...
public class LayerListListenerAdapter extends AdapterImpl {
    ...
    /**
     * This method is called when more than on layer has been added. <li>msg.getNewValue() will
     * return a list of the layers added</li> <li>msg.getNotifier() will return the ContextModel</li>
     * </ul> </p>
     * 
     * @param msg The Notification object with all the information about the event.
     */
