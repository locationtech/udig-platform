...
public class DropFilterActionTest extends AbstractProjectUITestCase {
    ...
    public void setUp() throws Exception {
        ...
        atts = new Object[] { fac.createPoint(new Coordinate(10, 10)), "targetName" }; //$NON-NLS-1$
    ...
    public void testPerform() throws Exception {
        ...
        AdaptingFilter aF = AdaptingFilterFactory.createAdaptingFilter(filter,
                sourceMap.getLayersInternal().get(0));
        ...
        action.perform(new NullProgressMonitor());
        final FeatureSource<SimpleFeatureType, SimpleFeature> featureSource = layer
        ...
        UDIGTestUtil.inDisplayThreadWait(2000, new WaitCondition() {
            ...
            public boolean isTrue() {
                try {
                    return 2 == featureSource.getFeatures().size()
                            && (layer.getFilter()) != Filter.EXCLUDE;
                } catch (IOException e) {
