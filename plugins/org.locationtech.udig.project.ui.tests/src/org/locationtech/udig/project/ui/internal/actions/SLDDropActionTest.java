...
public class SLDDropActionTest {
    ...
    public void setUp() throws Exception {
        ...
        sldURL = FileLocator.toFileURL(
                TestsUIPlugin.getDefault().getBundle().getEntry("test-data/teststyle.sld")); //$NON-NLS-1$
    ...
    /**
     * Test method for
     * {@link org.locationtech.udig.project.ui.internal.actions.SLDDropAction#accept()}.
     */
    @Test
    ...
    boolean isTestStyle(final ILayer destination, final String expectedName) {
        Style style = (Style) destination.getStyleBlackboard()
                .get("org.locationtech.udig.style.sld"); //$NON-NLS-1$
