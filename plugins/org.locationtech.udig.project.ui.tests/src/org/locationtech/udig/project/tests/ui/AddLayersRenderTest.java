...
public class AddLayersRenderTest extends AbstractProjectUITestCase {
    ...
    public void setUp() throws Exception {
        ...
        assertNotNull("map should have a renderManager", renderManagerInternal); //$NON-NLS-1$
        map.getRenderManagerInternal().refresh(null);
        UDIGTestUtil.inDisplayThreadWait(1000000, new WaitCondition() {

            @Override
            public boolean isTrue() {
                return map.getRenderManagerInternal().getRenderExecutor()
        ...
        AdapterImpl adapterImpl = new AdapterImpl() {
            ...
            public void notifyChanged(final Notification msg) {
                ...
                if (msg.getNotifier() instanceof RenderManager && msg.getFeatureID(
                        RenderManager.class) == RenderPackage.RENDER_MANAGER__RENDER_EXECUTOR) {
                    if (msg.getNewValue() != null) {
                        ((CompositeRendererImpl) map.getRenderManagerInternal().getRenderExecutor()
                                .getRenderer()).eAdapters().add(this);
                        ((CompositeRenderContext) map.getRenderManagerInternal().getRenderExecutor()
                                .getContext()).addListener(contextListener);
                    }
                    if (msg.getOldValue() != null) {
                        ((CompositeRendererImpl) map.getRenderManagerInternal().getRenderExecutor()
                                .getContext()).eAdapters().remove(this);
                        ((CompositeRenderContext) map.getRenderManagerInternal().getRenderExecutor()
                                .getContext()).removeListener(contextListener);
                    }
                } else {
                    if (msg.getNotifier() instanceof CompositeRendererImpl) {
                        if (msg.getNewValue() != null) {
                            ((CompositeRenderContext) map.getRenderManagerInternal()
                                    .getRenderExecutor().getContext()).addListener(contextListener);
                        }
                        if (msg.getOldValue() != null) {
                            ((CompositeRenderContext) map.getRenderManagerInternal()
                                    .getRenderExecutor().getContext())
        ...
        CompositeRendererImpl compRenderer = (CompositeRendererImpl) map.getRenderManagerInternal()
        ...
        CompositeRenderContext compContext = ((CompositeRenderContext) map
                .getRenderManagerInternal().getRenderExecutor().getContext());
    ...
    public void testAddOneLayer() throws Exception {
        ...
        resources.add(CatalogTests.createGeoResource(features, true));
    ...
    public void testAddMultipleLayers() throws Exception {
        ...
        resources.add(CatalogTests.createGeoResource(features, true));
        resources.add(CatalogTests.createGeoResource(features2, true));
        IGeoResource createGeoResource = CatalogTests.createGeoResource(features3, true);
